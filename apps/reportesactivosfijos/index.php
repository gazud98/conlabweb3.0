...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="/cw3/conlabweb3.0/apps/reportesactivosfijos/assets/style.css">
</head>
<style>
    .content-wrapper {
        background-image: url('/cw3/conlabweb3.0/apps/medicos/assets/backcw3-v1.png');
...
<body>
    ...
    <script src="/cw3/conlabweb3.0/apps/reportesactivosfijos/assets/index.js"></script>

    <script>
        $(document).ready(function() {
            $('.content-filter').load('/cw3/conlabweb3.0/apps/reportesactivosfijos/filter-name.php');
            $('.content-table').load('/cw3/conlabweb3.0/apps/reportesactivosfijos/table-reporte-1.php');
