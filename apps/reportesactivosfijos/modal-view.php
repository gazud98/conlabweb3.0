...
if ($conetar->connect_errno) {
    ...
    if ($id != "") {
        ...
        if ($numerfiles2 >= 1) {
            ...
            $tipo_activo = trim($filaP2['tipo_activo']);
...
?>
<table class="table table-bordered" id="tableInfoActivo">
    ...
    <tbody>
        <tr>
            ...
            <td><span><?php echo $modelo; ?></span></td>
        </tr>
        <tr>
            <td><strong>Serie:</strong></td>
            <td><span><?php echo $serie; ?></span></td>
            <td><strong>Sede:</strong></td>
            <td><span><?php echo $sede; ?></span></td>
        </tr>
        <tr>
            <td><strong>Departamento:</strong></td>
            <td><span><?php echo $departamento; ?></span></td>
            <td><strong>Tipo de activo fijo:</strong></td>
            <td><span><?php echo $tipo_activo; ?></span></td>
        </tr>
        <tr>
            <td><strong>Fecha de instalación:</strong></td>
            <td><span><?php echo $fchinstalacion; ?></span></td>
            <td><strong>Valor:</strong></td>
            <td><span><?php echo $valor; ?></span></td>
        </tr>
        <tr>
            ...
            <td><span><?php echo $valor_asegurado; ?></span></td>
        </tr>
        <tr>
            ...
            <td><span><?php
                        ...
                        ?></span></td>
            <td><strong>Fecha de expiración garantía:</strong></td>
            <td><span><?php echo $fchexpgarantia; ?></span></td>
        </tr>
        <tr>
            <td><strong>Proveedor - granatía:</strong></td>
            <td><span></span></td>
            <td><strong>Método de depreciación:</strong></td>
            <td><span></span></td>
        </tr>
        <tr>
            <td><strong>Vida util:</strong></td>
            <td><span><?php echo $vidautilmes; ?> años</span></td>
            <td><strong>Necesita mantenimiento:</strong></td>
            <td><span>
                    <?php

                    if ($op_mantenimiento == '1') {
                        echo 'SI';
                    } else if ($op_mantenimiento == '0') {
                        echo 'NO';
                    }
...
<script>
    $(document).ready(function() {
        miDataTableInfoActivo = $('#tableInfoActivo').DataTable({
            language: {
