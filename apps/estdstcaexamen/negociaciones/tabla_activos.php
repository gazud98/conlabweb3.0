...
if ($conetar->connect_errno) {
    ...
    FROM  cw3completa.producto a  where 1=1 " . $maxwhere;
    ...
    $cadena = "SELECT a.id_producto, a.nombre,a.id_departamento,a.id_sede,a.id_tipo_activo,b.garantia
     FROM cw3completa.producto a ,cw3completa.producto_activofijo b
     where 1=1 and id_categoria_producto ='1' and b.id_producto=a.id_producto and a.id_producto  not in (select id_activo from cw3completa.grupo_activos_fijos_detalle )" .$maxwhere;
    // echo $cadena;
    /**/
...
<script>
    function selectthefile2(thefile) {
        ...
        $('#col2' + thefile).css("border", "4px groove #dc3545");
            ...
            $("#data2").load("/desarrolloV3/apps/evento/datasg.php", {
                id_producto: id_producto,
                grupo:'N'
            });
       
       
        $("#tabla_grupoactsg").load("/desarrolloV3/apps/evento/tabla_grupoactsg.php", {
            idd: id_departamento,
            idsd: id_sede,
            idta: id_tipo_activo,
            id_producto: id_producto
