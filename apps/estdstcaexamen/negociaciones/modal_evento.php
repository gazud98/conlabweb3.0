...
?>
    ...
    <script>
        function seleccionar1(sel) {
            ...
            $("#period1").load('/desarrolloV3/apps/evento/periodicidad1.php', {
                caso: caso
            })
        ...
        function crearEvento1(id_producto) {
            ...
            $.ajax({
                type: 'POST',
                url: '/desarrolloV3/apps/evento/crud.php',
                data: {
                    rep: rep1,
                ...
                success: function(data) {
                    ...
                    $("#tableevento").load('/desarrolloV3/apps/evento/table_eventos.php');
                }
            })
