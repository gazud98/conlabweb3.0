...
<script>
    ...
    $(document).ready(function () {
        miDataTable = $('#table-dptos').DataTable({
            ...
            "responsive": true,
            "ajax": {
                url: 'https://cw3.tierramontemariana.org/apps/dptos/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function () {
                $.ajax({
                    type: 'POST',
                    url: 'https://cw3.tierramontemariana.org/apps/dptos/crud.php',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://cw3.tierramontemariana.org/apps/dptos/process_data.php',
            data: { id: id },
            dataType: 'json',
