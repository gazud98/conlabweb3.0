...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm" id="table-dptos">
    <thead>
        <tr>
...
<script>
    function exportarExcel() {
        ...
        var tabla = document.getElementById('table-dptos');
    ...
    $(document).ready(function () {
        miDataTable = $('#table-dptos').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/dptos/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function () {
                $.ajax({
                    type: 'POST',
                    url: 'https://conlabweb3.tierramontemariana.org/apps/dptos/crud.php',
                    ...
                    success: function (respuesta) {
                        if (respuesta == 1) {
                            Swal.fire({
                                ...
                                footer: 'Crea un departamento con un nuevo nombre'
                            })
                        } else {
                            Swal.fire({
                                position: 'top',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://conlabweb3.tierramontemariana.org/apps/dptos/process_data.php',
            data: { id: id },
            dataType: 'json',
