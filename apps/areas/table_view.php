...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm table-area" id="table-area">
    <thead>
        <tr>
...
<script>
    function exportarExcel() {
        ...
        var tabla = document.getElementById('table-area');
    ...
    $(document).ready(function() {
        miDataTable = $('.table-area').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/areas/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: 'https://conlabweb3.tierramontemariana.org/apps/areas/crud.php',
                    ...
                    success: function(respuesta) {
                        if (respuesta == 1) {
                            Swal.fire({
                                ...
                                footer: 'Crea una area con un nuevo nombre'
                            })
                        } else {
                            Swal.fire({
                                position: 'top',
    ...
    function editar(id) {
        ...
        $('#modalshow').load('https://conlabweb3.tierramontemariana.org/apps/areas/modal-editar.php', {
            id: id
        });
