    ...
    <script>
        $(document).ready(function() {
            ...
            miDataTable = $('#tb').DataTable({
                ...
                "responsive": true,
                "ajax": {
                    url: '/cw3/conlabweb3.0/apps/csltaordcompra/mostrarordenes.php', // Página PHP que devuelve los datos en formato JSON
        ...
        function selectthefile1(thefile, id) {
            ...
            $("#btnord").load("/cw3/conlabweb3.0/apps/csltaordcompra/modal.php", {
                id: id
            });
        }
    </script>
