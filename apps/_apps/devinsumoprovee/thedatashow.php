...
if ($conetar->connect_errno) {
    ...
    if (isset($_REQUEST['id'])) {
        ...
        $cadena = "SELECT id, insumo,cantidad,fecha,motivo,costo,no_factura,estado
...
?>
    ...
    <div class="col-md-12 col-lg-12 p-1" name="iddatas" id="iddatas" style="pointer-events: none;">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-3 col-lg-3">
                <label style="font-size: 12px;">Factura:</label>
                <input type="input"  class="form-control" name="factura" id="factura" value="<?php echo $factura; ?>"></input>
            </div>
