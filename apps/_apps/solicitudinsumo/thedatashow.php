...
if ($conetar->connect_errno) {
    ...
    if (isset($_REQUEST['id'])) {
        ...
        $cadena = "SELECT id_solicitud,solicitante,centro_costos,descripcion, insumo, cantidad,fecha,estado
             FROM u116753122_cw3completa.solicitud_insumo
        ...
        if ($numerfiles2 >= 1) {
            ...
            $id = trim($filaP2['id_solicitud']);
            $nombre = trim($filaP2['solicitante']);
            $estado = trim($filaP2['estado']);
            $centro_costos = trim($filaP2['centro_costos']);
...
?>
    ...
    <div class="col-md-12 col-lg-12 p-1" name="iddatas" id="iddatas" style="pointer-events: none;">
        ...
        <div class="row mb-2">
            ...
            <div class="col-md-3 col-lg-3 ">
                <label style="font-size: 12px;">Solicitante</label>
        ...
        <div class="row mb-2">
            <div class="col-md-4 col-lg-4">
                ...
                <input type="input" class="form-control" name="centro_costos" id="centro_costos" value="<?php echo $centro_costos; ?>"></input>
            </div>
