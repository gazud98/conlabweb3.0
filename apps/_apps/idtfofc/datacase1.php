                 ...
                 <input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
                    ...
                    <div class="row pb-2" style="width:100%; ">
                        ...
                        <div class="col-md-8 col-lg-8">
                            <input type="input" class="form-control" name="identificacion_legal" id="identificacion_legal"  value="<?php echo $identificacion_legal; ?>"></input>
                        </div>
                    ...
                    <div class="row  pb-2" style="width:100%;">
                                            ...
                                            <div class="row  pb-2" style="width:100%;">
                                                ...
                                                <div class="col-md-8 col-lg-8">
                                                    <input type="input" class="form-control" name="licencia" id="licencia" readonly value="<?php echo $licencia; ?>"></input>
                                                </div>
                                            ...
                                            <div class="row pb-2" style="width:100%;">
                                                ...
                                                <div class="col-md-8 col-lg-8">
                                                    <input type="input" class="form-control" name="nombre_empresa" id="nombre_empresa" value="<?php echo $nombre_empresa; ?>"></input>
                                                </div>
                                            ...
                                            <div class="row pb-2" style="width:100%;">
                                                ...
                                                <div class="col-md-8 col-lg-8">
                                                    <input type="input" class="form-control" name="codigo_postal" id="codigo_postal" value="<?php echo $codigo_postal; ?>"></input>
                                                </div>
                                            ...
                                            <div class="row pb-2" style="width:100%;">
                                                ...
                                                <div class="col-md-8 col-lg-8">
                                                    <input type="input" class="form-control" name="fax" id="fax" value="<?php echo $fax; ?>"></input>
                                                </div>
                                            ...
                                            <div class="row pb-2" style="width:100%;">
                                                <div class="col-md-4 col-lg-4">
                                                    <label ><strong>Dirección Electrónica :</strong></label>

                                                </div>

                                                <div class="col-md-8 col-lg-8">
                                                    <input type="input" class="form-control" name="direccion_electronica" id="direccion_electronica" value="<?php echo $direccion_electronica; ?>"></input>
                                                </div>
