...
//          si estadio es 1 pasa ra 0 o v iceversa
        ...
        $estado=trim($_POST['estado']);
            ...
            $predeterminada=trim($_POST['predeterminada']);
            ...
            if($modeeditstatus=="C"){////CREACION
                $cadena="insert into u116753122_cw3completa.bodegas(nombre,codigo,id_centro_costo,id_empleado,predeterminada,estado)values('".
                        $nombre.
                        "','".$codigo.
                        "','".$id_centro_costo.
                        "','".$id_empleado.
                ...
                $cadena="select id from  u116753122_cw3completa.bodegas where
                            nombre='".$nombre."'
                            and codigo='".$codigo."'
