...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm">
    ...
    <tbody>
        ...
        //******************************************************************************
            ...
            $cadena="SELECT id, nombre,estado,predeterminada
...
//                      echo $cadena;
            ...
            if($numerfiles2>=1){
                ...
                while($filaP2=mysqli_fetch_array($resultadP2)){
                    ...
                    $predeterminada=$filaP2['predeterminada'];
                    ...
                    echo '>';
                        ...
                        echo '<td style="font-size:0.8rem;"';
                            ...
                            if($predeterminada=="1") { echo '<br><span style="color:green;">Predeterminada</span>'; }
                        echo '</td>';
