...
//          si estadio es 1 pasa ra 0 o v iceversa
        $cadena="select estado from u116753122_cw3completa.unidad_medida where id_unidad_medida='".$id."'";
        ...
        $cadena= "update u116753122_cw3completa.unidad_medida set estado='".$estado."' where id_unidad_medida='".$id."'";
        ...
        $estado=trim($_POST['estado']);
            ...
            if($modeeditstatus=="C"){////CREACION
                $cadena="insert into u116753122_cw3completa.unidad_medida( nombre, simbolo, factor, redondeo, conversion, cantidad_decimal, estado)values('".
                $nombre."','".
                $simbolo."','".
                $factor."','".
                $redondeo."','".
