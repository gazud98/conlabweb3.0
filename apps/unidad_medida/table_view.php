...
<table class="table table-striped table responsive " id="table-unidad_medida" style="
                    font-size: 15px;
                    text-align: center;
...
<script>
    function exportarExcel() {
        ...
        var tabla = document.getElementById('table-unidad_medida');
    ...
    $(document).ready(function() {
        miDataTable = $('#table-unidad_medida').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: 'https://cw3.tierramontemariana.org/apps/unidad_medida/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: 'https://cw3.tierramontemariana.org/apps/unidad_medida/crud.php',
                    ...
                    success: function(respuesta) {
                        if (respuesta == 1) {
                            Swal.fire({
                                icon: 'error',
                                title: 'Oops...',
                                text: '¡Esta unidad de medida ya existe!',
                                footer: 'Crea una unidad de medida con un nuevo nombre'
                            })
                        } else {
                            Swal.fire({
                                position: 'top',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://cw3.tierramontemariana.org/apps/unidad_medida/process_data.php',
            dataType: 'json',
            data: {
                id: id
            },
            success: function(response) {
                ...
                $('#simboloedit').val(response.simbolo);
            },
