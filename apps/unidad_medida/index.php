...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="/cw3/conlabweb3.0/apps/unidad_medida/assets/style.css">
</head>
<style>
    .content-wrapper {
...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.content-table-unidad_medida').load('/cw3/conlabweb3.0/apps/unidad_medida/table_view.php');
