...
$nmbapp = "Listado de Unidades de medida";
...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="https://conlabweb3.tierramontemariana.org/apps/unidad_medida/assets/style.css">
</head>
<style>
    .content-wrapper {
...
<body>
        ...
        <div class="card-header bg-light ">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-right">
                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal" style="font-size:11px;background-color: rgb(0,69,165);border:none;"><i class="fas fa-plus" title="Crear nuevo registro"></i>&nbsp;&nbsp;Nueva Unidad de Medida</button>
                </div>
            </div>
        </div>
        <div class="card-body">
            <div class="row mt-3">
                <div class="col-md-12 content-table-unidad_medida">
            ...
            <div class="modal-content">
                <form name="formcontrol" id="formcontrol" action="" method="POST" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h4 class="modal-title">Crear Unidades de Medida</h4>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label>Simbolo:</label>
                            <input type="input" class="form-control" name="simbolo" id="simbolo" required>
                        </div>
            ...
            <div class="modal-content">
                <form id="formeditar" action="#" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body" id="modalshow">
                        ...
                        <div class="form-group">
                            <label>Simbolo:</label>
                            <input type="input" class="form-control" name="simbolo" id="simboloedit" required value="">
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.content-table-unidad_medida').load('https://conlabweb3.tierramontemariana.org/apps/unidad_medida/table_view.php');
