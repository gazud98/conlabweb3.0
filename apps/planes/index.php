...
if ($conetar->connect_errno) {
    ...
    if ($id != "") {
        $cadena = "select P.id ,P.descripcion,P.estado
                    from cw3completa.especialidades P
                    where P.id='" . $id . "'";
        //                     echo $cadena;
...
?>
    ...
    <body>
        ...
        <div class="content-table" style="width: 80%;margin:auto;">
                ...
                <div class="table-title" style="padding: 30px;">
                    <div class="row">
                        <div class="col-md-4">
                            <div class="">
                                <nav class="breadcrumbs">
                                    ...
                                    <a href="#" class="breadcrumbs__item is-active" style="text-decoration: none;">Planes</a>
                                </nav>
                        ...
                        <div class="col-md-4" style="text-align: center; padding: 10px">
                            <h4><strong>Creación de Planes</strong></h4>
                        </div>
                        <div class="col-md-4">
                ...
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <form id="formeditar" action="#" method="POST" enctype="multipart/form-data">
                        <div class="modal-body" id="modalEditPlan">
