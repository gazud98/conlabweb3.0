...
?>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-lg-6">
                    <nav class="breadcrumbs">
                        ...
                        <a href="#" class="breadcrumbs__item is-active" style="text-decoration: none;">Sedes</a>
                    </nav>
        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-5 col-lg-5" style="overflow:hidden; overflow-y:auto;">
                    ...
                    height:280px;width:auto;"></div><?php //aqui va thedatatable.php //tabla de la app 
                                                    ?>
    ...
    <script>
        ...
        function inhabilitacmpos() {
            ...
            $("#iddatas").css("background-color", "#F6FBFF");
