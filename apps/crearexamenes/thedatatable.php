    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            miDataTable = $('#table-examen').DataTable({
                ...
                "responsive": true,
                "ajax": {
                    url: '/cw3/conlabweb3.0/apps/crearexamenes/mostrar.php', // Página PHP que devuelve los datos en formato JSON
            ...
            $.validator.setDefaults({
                submitHandler: function() {
                    $.ajax({
                        type: 'POST',
                        url: '/cw3/conlabweb3.0/apps/crearexamenes/crud.php',
        ...
        function editar(id) {
            ...
            $.ajax({
                type: 'GET',
                url: '/cw3/conlabweb3.0/apps/crearexamenes/process_data.php',
                data: {
                    id: id
                },
                dataType: 'json',
