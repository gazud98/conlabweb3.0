            ...
            <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <label style="font-size: 12px;">Evento</label>
                                <input type="input" class="form-control" name="fndevento" id="fndevento" style="width: 100%; height: 28px;font-size: 12px;"></input>
                            </div>
                            <div class="col-md-12 col-lg-12">
