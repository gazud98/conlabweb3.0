...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm">
    ...
    <tbody>
        ...
        //******************************************************************************
            ...
            $cadena="SELECT id_empleados, nombres,estado
            ...
            if($numerfiles2>=1){
                ...
                while($filaP2=mysqli_fetch_array($resultadP2)){
                    $id=trim($filaP2['id_empleados']);                      //RESPETAR EL $ID QES LA QUE CARGA LA LLAVE PRIMARIA
                    $nombre=$filaP2['nombres'];                         //RESPETAR EL $NOMBRE ES PARA MOSAR CUAL ESL EL NOMBRE UNICO
