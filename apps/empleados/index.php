...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="/cw3/conlabweb3.0/apps/empleados/assets/style.css">
</head>
<style>
    .content-wrapper {
        background-image: url('/cw3/conlabweb3.0/apps/medicos/assets/backcw3-v1.png');
...
<body>
    ...
    <script>
        function loadFormEmployee() {
            $('#contentFormEmployee').load('/cw3/conlabweb3.0/apps/empleados/datacase1.php');
        }

        $(document).ready(function() {
            $('#contentTableEmploye').load('/cw3/conlabweb3.0/apps/empleados/thedatatable.php');
        })

        function setEmployee() {
            $.ajax({
                type: 'POST',
                url: '/cw3/conlabweb3.0/apps/empleados/crud.php?aux=1',
        ...
        function updateEmployee() {
            $.ajax({
                type: 'POST',
                url: '/cw3/conlabweb3.0/apps/empleados/crud.php?aux=2',
