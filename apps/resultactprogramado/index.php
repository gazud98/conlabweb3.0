...
if ($conetar->connect_errno) {
    ...
    // echo $sctrl1;
    $nmbapp = "RESULTADOS DE LAS ACTIVIDADES PROGRAMADAS";
    ...
    <div class="card border-info">
        ...
        <div class="card-body">
            <div class="row">
                ...
                <div class="col-md-7 col-lg-7" style="overflow:hidden; overflow-y:auto;" name="divappshow" id="divappshow" style="display:none">
