          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12">
                                <label style="font-size: 12px;">Actividad</label>
                                <input type="input" class="form-control" name="fndactividad" id="fndactividad" style="width: 100%; height: 28px;font-size: 12px;"></input>
                            </div>
                        </div>
...
<script>
    function generafilters(){
        ...
        var fndactividad=$("#fndactividad").val();
      //  alert(fndnombre);
