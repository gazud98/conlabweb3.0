            ...
            <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <input type="input" class="form-control" name="fndproveedor" id="fndproveedor" style="width: 100%; height: 28px;font-size: 12px;"></input>
                            </div>
                            <div class="col-md-12 col-lg-12">
...
<script>
    function generafilters(){
        ...
        var fndproveedor=$("#fndproveedor").val();
