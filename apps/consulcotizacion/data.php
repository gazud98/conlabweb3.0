...
if ($conetar->connect_errno) {
    ...
    <script>
        function grabador(id) {
            ...
            $.ajax({
                type: 'POST',
                url: 'https://cw3.tierramontemariana.org/apps/consulcotizacion/crud.php',
                data: {
                    id: id,
        ...
        function generarOrden() {
            ...
            $.ajax({
                type: 'POST',
                url: 'https://cw3.tierramontemariana.org/apps/consulcotizacion/creaorden.php',
                data: {
                    id: <?php echo $ide ?>
                },
                success: function (datax) {
                    ...
                    if ($.trim(datax) == 'N') {
                        ...
                        $.ajax({
                            type: 'POST',
                            url: 'https://cw3.tierramontemariana.org/apps/consulcotizacion/mostrarorden.php',
                            data: {},
                            success: function (respuesta) {
                                if (respuesta === null || respuesta.trim() === '') {
                                    ...
                                    $("#modalshow").load("https://cw3.tierramontemariana.org/apps/consulcotizacion/modal.php", {
                                        id: respuesta
                                    });
