...
if ($conetar->connect_errno) {
    ...
    <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/consulcotizacion/assets/style.css">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content" id="modalContent">
                    ...
                    <div class="modal-body" id="modalshow" name="modalshow">
                        <?php include ("https://cw3.tierramontemariana.org/apps/consulcotizacion/modal.php") ?>
                    </div>
    ...
    <script src="https://cw3.tierramontemariana.org/apps/consulcotizacion/jsPDF/dist/jspdf.min.js"></script>
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#thetable').load('https://cw3.tierramontemariana.org/apps/consulcotizacion/thedatatable.php');
