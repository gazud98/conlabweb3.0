...
<head>
    ...
    <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/sedes/assets/style.css">
</head>

<body>
    <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/listasolicitud/assets/style.css">
    ...
    <script src="https://cw3.tierramontemariana.org/apps/listasolicitud/assets/index.js"></script>
    <script>
        ...
        $(document).ready(function () {
            ...
            $(document).ready(function () {
                $('#thetable').load('https://cw3.tierramontemariana.org/apps/listasolicitud/table_view.php');
            });
