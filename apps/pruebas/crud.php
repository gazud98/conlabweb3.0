...
//          si estadio es 1 pasa ra 0 o v iceversa
        $cadena="select estado from u116753122_cw3completa.pruebas where id='".$id."'";
        ...
        $cadena= "update u116753122_cw3completa.pruebas set estado='".$estado."' where id='".$id."'";
        ...
        $estado=trim($_POST['estado']);
            ...
            if($modeeditstatus=="C"){////CREACION
                $cadena="insert into u116753122_cw3completa.pruebas(nombre,estado)values('".
                        $nombre.
                        "','1')";
                $resultado = mysqli_query($conetar,$cadena);

                //bujscamos el id para el proce sde predetemando...
                $cadena="select id from  u116753122_cw3completa.pruebas where
                            nombre='".$nombre."'
                            and estado='".$estado."'";
                $resultadP2a=$conetar->query($cadena);
                $numerfiles2a = mysqli_num_rows($resultadP2a);
                ...
                if($modeeditstatus=="E"){//acgualzucsion
                    $cadena="update u116753122_cw3completa.pruebas set
                                nombre='".$nombre."'
                            where id='".$id."'";
                    $resultado = mysqli_query($conetar,$cadena);
                     $result="ok";
