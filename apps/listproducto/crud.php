...
//          si estadio es 1 pasa ra 0 o v iceversa
        ...
        if ($id_categoria_producto=="1"){  //activo fijo
            ...
            if($modeeditstatus=="C"){////CREACION
                 $cadena="insert into u116753122_cw3completa.producto(id_categoria_producto,nombre,referencia,id_departamento,id_sede,id_tipo_activo)values('".
                                $id_categoria_producto."','".$nombre."','".$referencia."','".$id_departamento."','".$id_sedes."','".$id_tipo_activo."')";
                $resultado = mysqli_query($conetar,$cadena);
                //busco el id
                    ...
                    if($numerfiles2>=1){
                        ...
                        $cadena="insert into u116753122_cw3completa.producto_activofijo(id_producto,valor,modelo,serie,
                                       fchinstalacion,seguro,seguroprima,garantia,
                                        fchexpgarantia,vidautilmes,metdepreciacion,id_proveegarantia,id_responsable)values('".
                                        $id."','".$valor."','".$modelo."','".$serie."','".
                                        $fchinstalacion."','".$seguro."','".$seguroprima."','".$garantia."','".
                                        $fchexpgarantia."','".$vidautilmes."','".$metdepreciacion."','".$proveegarantia."','".$responsable."')";
                        $resultado = mysqli_query($conetar,$cadena);
                    }
                    $result="ok";
            }else{
            ...
            if($modeeditstatus=="C"){////CREACION
                ...
                $cadena="select id_producto
                    ...
                    if($numerfiles2>=1){
                        ...
                        $id=$filaP2a['id_producto'];
                        //no existe creo
                        $cadena="insert into u116753122_cw3completa.producto_reactivo(id_producto,costo,estante)values('".
                                        $id."','".$costo."','".$estante."')";
                        $resultado = mysqli_query($conetar,$cadena);
                    }
                $result="ok";
                ...
                if($modeeditstatus=="E"){//acgualzucsion
                    ...
                    //asegruo que este en la tabla de campso adicoanes pde activos fijos
                    $cadena="select id_producto
                                from u116753122_cw3completa.producto_reactivo
                                where id_producto='".$id."'";
                    $resultadP2=$conetar->query($cadena);
                    $numerfiles2 = mysqli_num_rows($resultadP2);
                    if($numerfiles2>=1){
                        //exite actualizao
                        $cadena="update u116753122_cw3completa.producto_reactivo set
                                    id_categoria_producto='".$id_categoria_producto."',
                                    nombre='".$nombre."',
                                    referencia='".$referencia."',
                                    id_departamento='".$id_departamento."',
        ...
        if ($id_categoria_producto=="3"){//produtos
            ...
            if($modeeditstatus=="C"){////CREACION
                 $cadena="insert into u116753122_cw3completa.producto(id_categoria_producto,nombre,referencia,id_departamento,
                                    cantidad_presentacion,id_presentacion,cantidad_unidadmedida,id_unidadmedida,
                                    id_clasificacion_riesgo,nombre_imagen,id_bodegas,stckmin,
                                    stckpntoreorden,stckmax,csmoprommes,id_condicion_almacenaje,cod_contable
                                )values('".
                                $id_categoria_producto."','".$nombre."','".$referencia."','".$id_departamento."','".
                                $cantidad_presentacion."','".$id_presentacion."','".$cantidad_unidadmedida."','".$id_unidadmedida."','".
                                $id_clasificacion_riesgo."','".$nombre_imagen."','".$id_bodegas."','".$stckmin."','".
                                $stckpntoreorden."','".$stckmax."','0','".$id_condicion_almacenaje."','".$cod_contable."')";
...
//...............................................................................................................................................................
        ...
        if ($id_categoria_producto=="4"){//servciicos
            ...
            if($modeeditstatus=="C"){////CREACION
                 $cadena="insert into u116753122_cw3completa.producto(id_categoria_producto,nombre,referencia,id_departamento,id_sede)values('".
