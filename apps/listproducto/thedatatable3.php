...
?>
    ...
    <table class="table table-striped table-hover table-head-fixed text-nowrap table-sm table-list-producto">
        <thead>
            <tr>
                <th>Codigo</th>
                <th>Nombre</th>
        ...
        <tbody>
            ...
            ON p.id_sede = a.id_sedes WHERE p.nombre LIKE '%$bcar%' or p.id_producto LIKE '%$bcar%';";
            //                      echo $cadena;
            //echo $sctrl1;
            /* */
