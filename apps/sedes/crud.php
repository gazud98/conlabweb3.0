...
if ($conetar->connect_errno) {
    ...
    if ($modeeditstatus == "D") { //es de desahibilitar/habikitr
        ...
        if ($modeeditstatus == "C") { ////CREACION
            $consulta = "SELECT nombre FROM u116753122_cw3completa.sedes WHERE nombre = '$nombre'";
            ...
            if (mysqli_num_rows($resultado) > 0) {
                ...
                $cadena = "insert into u116753122_cw3completa.sedes(nombre,fecha,hora,estado)values('" . $nombre . "','" . $fecha . "','" . $hora . "',1)";
                $resultado = mysqli_query($conetar, $cadena);
            }
            ...
            if ($modeeditstatus == "E") { //acgualzucsion
                ...
                if ($modeeditstatus == "B") { //acgualzucsion
                    $cadena = "DELETE FROM u116753122_cw3completa.sedes where id_sedes='" . $id . "'";
                    $resultado = mysqli_query($conetar, $cadena);
                }
            }
        } //De es insetar
