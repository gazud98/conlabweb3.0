...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm  table-sedes" id="table-sedes">
    <thead>
        <tr>
...
<script>
    function exportarExcel() {
        ...
        var tabla = document.getElementById('table-sedes');
    ...
    $(document).ready(function () {
        ...
        miDataTable = $('.table-sedes').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/sedes/show_data.php', // Página PHP que devuelve los datos en formato JSON
            ...
            "columns": [
                ...
                },
                {
                    "data": null,
                    "render": function (data, type, full, meta) {
                        var editarLink = '<a href="#" onclick="editar(' + full.codigo + ')" data-target="#editsedeModal" data-toggle="modal" style="color: #E8A200;" title="Editar"><i style="font-size:13px;" id="icon" class="fa-solid fa-eye"></i><span></span></a>';
        ...
        $.validator.setDefaults({
            submitHandler: function () {
                $.ajax({
                    type: 'POST',
                    url: 'https://conlabweb3.tierramontemariana.org/apps/sedes/crud.php',
                    ...
                    success: function (respuesta) {
                        ...
                        if (respuesta == 1) {
                            Swal.fire({
                                ...
                                footer: 'Crea una sede con un nuevo nombre'
                            })
                        } else {
                            Swal.fire({
                                position: 'top',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://conlabweb3.tierramontemariana.org/apps/sedes/process_data.php',
            dataType: 'json',
            data: { id: id },
