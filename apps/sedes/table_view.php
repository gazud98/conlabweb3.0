...
<script>
    ...
    $(document).ready(function () {
        ...
        miDataTable = $('.table-sedes').DataTable({
            ...
            "responsive": true,
            "ajax": {
                url: 'https://cw3.tierramontemariana.org/apps/sedes/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function () {
                $.ajax({
                    type: 'POST',
                    url: 'https://cw3.tierramontemariana.org/apps/sedes/crud.php',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://cw3.tierramontemariana.org/apps/sedes/process_data.php',
            dataType: 'json',
            data: { id: id },
