...
<script>
    ...
    $(document).ready(function () {
        ...
        miDataTable = $('.table-sedes').DataTable({
            ...
            "responsive": true,
            "ajax": {
                url: '/cw3/conlabweb3.0/apps/sedes/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function () {
                $.ajax({
                    type: 'POST',
                    url: '/cw3/conlabweb3.0/apps/sedes/crud.php',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: '/cw3/conlabweb3.0/apps/sedes/process_data.php',
            dataType: 'json',
            data: { id: id },
