...
if ($id_departamento != '') {
    $filtro .= " AND de.id LIKE '%" . $id_departamento . "%'";
}

if ($solicitante != '') {
    $filtro .= " AND a.id_persona LIKE '%" . $solicitante . "%'";
}
...
if ($conetar->connect_errno) {
    ...
    $query = "SELECT distinct a.id,a.fecha, e.nombre,c.nombre as nombre_sede,de.nombre as nombre_dpto,  case when a.estado = 'P' then 'Pendiente' WHEN a.estado = 'F' THEN 'Finalizado' end as estado_solicitud, 
        b.nombre_1,b.nombre_2,b.apellido_1,b.apellido_2
         ...
         u116753122_cw3completa.ordrequisicion_detalle d,u116753122_cw3completa.centro_costos e,u116753122_cw3completa.departamentos de
          where  b.id_persona = a.id_persona 
          and a.id_sede = c.id_sedes  and a.id = d.id_req and e.id = d.ccosto and de.id = d.id_departamento" . $filtro;
