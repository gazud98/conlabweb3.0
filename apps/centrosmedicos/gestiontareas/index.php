            ...
            <div class="row mt-1">
                <div class="card" style="width:100%;margin:auto;">
                    <div class="card-header">
                        <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#exampleModal"><i class="fa-solid fa-plus"></i> Crear Tarea</button>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="row mt-1">
                                <div class="col-md-12">
                                    ...
                                    <select class="form-control" name="responsable" id="responsable">
                                        <option value="" selected disabled></option>
                                        <option value="1">Didier Urueta</option>
                                    </select>
                                </div>
                            </div>
