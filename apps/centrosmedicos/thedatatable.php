...
?>
    ...
    <table class="table table-striped table-sedes" style="
        ...
        <tbody>
            ...
            $cadena = "SELECT id_centro, nombre_centro, direccion_centro, estado
                    FROM  u116753122_cw3completa.centros_medicos order by 1 ";
            //                      echo $cadena;
            /* */
            ...
            if ($numerfiles2 >= 1) {
                ...
                while ($filaP2 = mysqli_fetch_array($resultadP2)) {
                    $id = trim($filaP2['id_centro']);                      //RESPETAR EL $ID QES LA QUE CARGA LA LLAVE PRIMARIA
                    $nombre = $filaP2['nombre_centro'];
                    $direccion = $filaP2['direccion_centro'];                           //RESPETAR EL $NOMBRE ES PARA MOSAR CUAL ESL EL NOMBRE UNICO
            ...
            ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="#" onclick="editar(<?php echo $id; ?>);" data-target="#editsedeModal" data-toggle="modal" style="color: #E8A200;" title="Editar"><i style="font-size:18px;" id="icon" class="fa-solid fa-pen-to-square"></i><span></span></a>
    ...
    <script>
        ...
        function editar(id) {
            ...
            $('#editCentroMedico').load('https://cw3.tierramontemariana.org/apps/centrosmedicos/modal-editar.php', {
                id: id
            });
