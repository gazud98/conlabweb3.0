...
<script>
    ...
    $(document).ready(function() {
        ...
        miDataTable = $('.table-departamento').DataTable({
            ...
            // ... Otras opciones ...
            "ajax": {
                url: 'https://cw3.tierramontemariana.org/apps/trasladodepartamento/mostrar.php', // Página PHP que devuelve los datos en formato JSON
    ...
    function selectthefile3(thefile) {
        ...
        $("#btndep").load("https://cw3.tierramontemariana.org/apps/trasladodepartamento/trasladodep.php", {
            id_produ: id_produ,
