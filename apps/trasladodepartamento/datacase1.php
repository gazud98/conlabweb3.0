                            ...
                            <div class="row mb-2">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <select class="form-control" name="id_empleado" id="id_empleado">
                                       <?php
                                        $cadena="SELECT id_empleados,nombre_empleado
                                        ...
                                        if($numerfiles2a>=1){
                                            while( $filaP2a=mysqli_fetch_array($resultadP2a)){
                                                echo "<option value='".trim($filaP2a['id_empleados'])."'";
                                                    if(trim($filaP2a['id_empleados'])==$id_empleado){ echo ' selected'; }
                                                echo '>'. $filaP2a['nombre_empleado']."</option>";
                                            }
                                        }
                                        ?>
                                    </select>
