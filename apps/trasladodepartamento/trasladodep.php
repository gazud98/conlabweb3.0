...
<script>
    function agregarxy(sel) {
        ...
        $("#resp").load("https://cw3.tierramontemariana.org/apps/trasladodepartamento/solicitante.php", {
            idd: idd
        });
        ...
        if (productofecha === 'T') {
            ...
            if (cante <= 0) {
                ...
                if (cante >= cant) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'https://cw3.tierramontemariana.org/apps/trasladodepartamento/crud.php',
                        data: {
