...
if ($conetar->connect_errno) {
    ...
    $cadena = "SELECT a.idbodegaentrapanio,b.referencia,a.idproducto,a.identrepanio,d.id as idstand,e.id as idbodega,c.nombre as entrepanio,d.nombre as stand,e.nombre as bodega,a.fchvence, SUM(a.cant_recibida) as cant,b.nombre ,@row_number := @row_number + 1 as numero_file
