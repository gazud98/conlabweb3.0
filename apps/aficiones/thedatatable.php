...
?>
    ...
    <table class="table table-striped" id="table-unidad_medida" style="
        ...
        <tbody>
            ...
            $cadena = "SELECT id, nombre, estado
                    FROM  u116753122_cw3completa.aficiones order by 1 ";
            //                      echo $cadena;
            /* */
    ...
    <script>
        $(document).ready(function() {
            ...
            $.validator.setDefaults({
                submitHandler: function() {
                    $.ajax({
                        type: 'POST',
                        url: 'https://cw3.tierramontemariana.org/apps/aficiones/crud.php',
        ...
        function editar(id) {
            ...
            $('.cargar-aficiones').load('https://cw3.tierramontemariana.org/apps/aficiones/modal-editar.php', {
                id: id
            });
