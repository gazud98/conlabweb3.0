<?php
// echo $sctrl1;
$nmbapp = "Listado de Tipos de Identificacion";
...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="https://conlabweb3.tierramontemariana.org/apps/tipoidentificacion/assets/style.css">
</head>
<style>
    .content-wrapper {
...
<body>
    ...
    <div class="card" style="width:85%;margin:auto;">
        ...
        <div class="card-header bg-light ">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    <h5 style="text-align: center; color: #0045A5;"><strong>Listado de Tipos de Identificacion</strong>
                    </h5>
                </div>
                <div class="col-md-4 text-right">
                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"
                        style="font-size:11px;background-color: rgb(0,69,165);border:none;"><i
                            class="fas fa-plus"></i>&nbsp;&nbsp;Nuevo Tipo Identificación</button>
        ...
        <div class="card-body">
            ...
            <div class="row mt-3">
                <div class=" col-md-12 content-table-tipoidentificacion">
            ...
            <div class="modal-content">
                <form name="formcontrol" id="formcontrol" action="#" method="POST" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h4 class="modal-title">Crear Tipos de Identificacion</h4>
        ...
        <div class="modal-dialog" id="editmodal">
            <div class="modal-content">
                <form id="formeditar" action="#" method="POST" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h4 class="modal-title">Editar Tipos de Identificacion</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    </div>
                    <div class="modal-body" id="modalshow">
                        ...
                        <div class="form-group">
                            <label>Abreviatura</label>
                            <input type="text" class="form-control" name="abreviatura" id="abreviaturaedit" required
                                value="">
                        </div>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.content-table-tipoidentificacion').load(
                'https://conlabweb3.tierramontemariana.org/apps/tipoidentificacion/table_view.php');
