...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/tipoidentificacion/assets/style.css">
</head>
<style>
    .content-wrapper {
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.content-table-tipoidentificacion').load(
                'https://cw3.tierramontemariana.org/apps/tipoidentificacion/table_view.php');
