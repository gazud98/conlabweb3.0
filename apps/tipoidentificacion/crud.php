...
if ($conetar->connect_errno) {
    ...
    if ($modeeditstatus == "D") { //es de desahibilitar/habikitr
        ...
        $cadena = "select estado from u116753122_cw3completa.tipo_identificacion where id='" . $id . "'";
        ...
        $cadena = "update u116753122_cw3completa.tipo_identificacion set estado='" . $estado . "' where id='" . $id . "'";
        ...
        if ($modeeditstatus == "C") { ////CREACION
            $consulta = "SELECT nombre FROM u116753122_cw3completa.tipo_identificacion WHERE nombre = '$nombre'";
            $resultado = mysqli_query($conetar, $consulta);
            if (mysqli_num_rows($resultado) > 0) {
                $respuesta = 1;
                echo $respuesta;
            } else {
                $cadena = "insert into u116753122_cw3completa.tipo_identificacion(nombre,abreviatura,estado)values('" . $nombre . "','" . $abreviatura . "',1)";
                $resultado = mysqli_query($conetar, $cadena);
            }
            ...
            if ($modeeditstatus == "E") { //acgualzucsion
                $cadena = "update u116753122_cw3completa.tipo_identificacion set
                                nombre='" . $nombre . "',
                ...
                if ($modeeditstatus == "B") { //acgualzucsion
                    $cadena = "DELETE FROM u116753122_cw3completa.tipo_identificacion where id='" . $id . "'";
                    $resultado = mysqli_query($conetar, $cadena);
                }
            }
        } //De es insetar
