...
<script>
    ...
    $(document).ready(function () {
        miDataTable = $('#table-tipoidentificacion').DataTable({
            ...
            "responsive": true,
            "ajax": {
                url: '/cw3/conlabweb3.0/apps/tipoidentificacion/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function () {
                $.ajax({
                    type: 'POST',
                    url: '/cw3/conlabweb3.0/apps/tipoidentificacion/crud.php',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: '/cw3/conlabweb3.0/apps/tipoidentificacion/process_data.php',
            dataType: 'json',
            data: { id: id },
    ...
    function cargarDatos() {
        $.ajax({
            url: '/cw3/conlabweb3.0/apps/tipoidentificacion/show_data.php.php', // Página PHP que devuelve los datos en formato JSON
            type: 'GET', // Método de la petición (GET o POST según corresponda)
            dataType: 'json', // Tipo de datos esperado en la respuesta
