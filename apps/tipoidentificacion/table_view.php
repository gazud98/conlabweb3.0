...
<script>
    ...
    $(document).ready(function () {
        miDataTable = $('#table-tipoidentificacion').DataTable({
            ...
            "responsive": true,
            "ajax": {
                url: 'https://cw3.tierramontemariana.org/apps/tipoidentificacion/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function () {
                $.ajax({
                    type: 'POST',
                    url: 'https://cw3.tierramontemariana.org/apps/tipoidentificacion/crud.php',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://cw3.tierramontemariana.org/apps/tipoidentificacion/process_data.php',
            dataType: 'json',
            data: { id: id },
    ...
    function cargarDatos() {
        $.ajax({
            url: 'https://cw3.tierramontemariana.org/apps/tipoidentificacion/show_data.php.php', // Página PHP que devuelve los datos en formato JSON
            type: 'GET', // Método de la petición (GET o POST según corresponda)
            dataType: 'json', // Tipo de datos esperado en la respuesta
