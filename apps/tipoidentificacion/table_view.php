...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm" id="table-tipoidentificacion">
    <thead>
        <tr>
...
<script>
    function exportarExcel() {
        ...
        var tabla = document.getElementById('table-tipoidentificacion');
    ...
    $(document).ready(function () {
        miDataTable = $('#table-tipoidentificacion').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/tipoidentificacion/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function () {
                $.ajax({
                    type: 'POST',
                    url: 'https://conlabweb3.tierramontemariana.org/apps/tipoidentificacion/crud.php',
                    ...
                    success: function (respuesta) {
                        if (respuesta == 1) {
                            Swal.fire({
                                icon: 'error',
                                title: 'Oops...',
                                text: '¡Este Tipo de Identificacion ya existe!',
                                footer: 'Crea un Tipo de Identificacion con un nuevo nombre'
                            })
                        } else {
                            Swal.fire({
                                position: 'top',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://conlabweb3.tierramontemariana.org/apps/tipoidentificacion/process_data.php',
            dataType: 'json',
            data: { id: id },
    ...
    function cargarDatos() {
        $.ajax({
            url: 'https://conlabweb3.tierramontemariana.org/apps/tipoidentificacion/show_data.php.php', // Página PHP que devuelve los datos en formato JSON
            type: 'GET', // Método de la petición (GET o POST según corresponda)
            dataType: 'json', // Tipo de datos esperado en la respuesta
