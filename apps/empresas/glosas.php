...
?>
    ...
    <script>
        $(document).ready(function() {
            //$('.content-table-glosas').load('https://cw3.tierramontemariana.org/apps/empresas/table-glosas.php');
            $('.content-motivo-glosa').load('/cw3/apps/empresas/table-motivo-glosas.php');
            //$('.content-notas').load('https://cw3.tierramontemariana.org/apps/empresas/table-notas-contables.php');
