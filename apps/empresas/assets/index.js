$(document).ready(function () {
    ...
    $('.content-info-basic').load('/cw3/conlabweb3.0/apps/empresas/info-basica.php');
    $('.content-datos-contacto').load('/cw3/conlabweb3.0/apps/empresas/datos-contacto.php');
    $('.content-datos').load('/cw3/conlabweb3.0/apps/empresas/otros-datos.php');
    $('#datos-facturacion').load('/cw3/conlabweb3.0/apps/empresas/info-facturacion.php');
    $('#info-cartera').load('/cw3/conlabweb3.0/apps/empresas/info-cartera.php');
    $('.content-table-req-insumos').load('/cw3/conlabweb3.0/apps/empresas/table-req-insumos.php');
    $('.content-table-docs').load('/cw3/conlabweb3.0/apps/empresas/table-docs.php');
    $('#info-glosas').load('/cw3/conlabweb3.0/apps/empresas/glosas.php');
    $('#info-tributaria').load('/cw3/conlabweb3.0/apps/empresas/info-tributaria.php');
...
function setEmpresa() {
    ...
    $.ajax({
        ...
        success: function (respuesta) {
            ...
            $('#contentTableEmpresas2').load('../cw3/conlabweb3.0/apps/empresas/table-empresas.php');
        }
    });
...
function loadModalEditEmpresa(id) {
    $('.content-edit-empresa').load('/cw3/conlabweb3.0/apps/empresas/modal-edit-empresa.php', {
        id: id
    });
}
...
function loadModalEditPlan(id) {
    $('#showTextFields').load('/cw3/conlabweb3.0/apps/empresas/modal-edit-planes.php', {
        id: id
    });
}
...
function deleteEmpresa(id) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: 'POST',
                url: '/cw3/conlabweb3.0/apps/empresas/crud.php?aux=9',
                data: {
                    id: id
                },
                success: function (respuesta) {
...
function setInfoFact() {
    ...
    $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/empresas/crud.php?aux=5',
...
function setMotivoGlosas() {
    ...
    $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/empresas/crud.php?aux=4',
...
function updateMotivoGlosas() {
    ...
    $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/empresas/crud.php?aux=10',
        data: $('#formMotivoGlosas').serialize(),
        success: function (respuesta) {
            //alert("¡Registro Exitoso!");
            Swal.fire({
...
function setEntidadesBancarias() {
    ...
    $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/empresas/crud.php?aux=6',
...
function loadEdnBanc(id) {
    $('#contentTextFileds').load('/cw3/conlabweb3.0/apps/empresas/modal-end-banc-edit.php', {
        id: id
    });
}
...
function deleteEndBanc(id) {
    Swal.fire({
        ...
        $.ajax({
            type: 'POST',
            url: '/cw3/conlabweb3.0/apps/empresas/crud.php?aux=12',
            data: {
                id: id
            },
            success: function (respuesta) {
...
function loadMotivosGlosas(id) {
    $('#modalMotivoGlosas').load('/cw3/conlabweb3.0/apps/empresas/modal-edit-motivos-glosas.php', {
        id: id
    });
}