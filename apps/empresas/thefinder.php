        ...
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h4 class="modal-title"><i class="fa-solid fa-magnifying-glass"></i>&nbsp;&nbsp;Busqueda</h4>
            ...
            <div class="modal-footer justify-content-between">
              <button type="button" class="btn btn-light border-light" data-dismiss="modal"><i class="fa-solid fa-xmark"></i>&nbsp;&nbsp;Cerrar Filtro</button>
              <button type="button" class="btn btn-primary" onclick="generafilters()"><i class="fas fa-plus"></i>&nbsp;&nbsp;Aplicar Filtro</button>
            </div>
          </div>
          <!-- /.modal-content -->
        </div>
