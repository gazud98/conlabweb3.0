...
?>
    ...
    <script>
        function selectthefile(thefile, id) {
            ...
            $("#tbmodal").load("https://cw3.tierramontemariana.org/apps/ordcompra/talbemodal.php", {
                id: id
            });
        }
        ...
        function agregarOrden() {
            ...
            $.ajax({
                type: 'POST',
                url: 'https://cw3.tierramontemariana.org/apps/ordcompra/crud.php',
                data: {
                    id: id,
                    id_prov: id_prov,
                    id_prod: id_prod,
                ...
                success: function(data) {
                    ...
                    $("#table").load("https://cw3.tierramontemariana.org/apps/ordcompra/tabla.php", {
                        ide: id_prod
                    });
        ...
        function mostrarOrden(idorden) {
            ...
            $("#ord").load("https://cw3.tierramontemariana.org/apps/ordcompra/verorden.php", {
                idorden: idorden
            });
