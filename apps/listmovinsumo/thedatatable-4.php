    ...
    <div class="col-md-6 col-lg-6">
        <div id="dt">
            ...
            <button type="button" value="Filtrar" style="
                    border: 1px solid #aaa;
                    border-radius: 4px;height: 28px; background-color: rgb(0,69,165);color:white;font-size: 13px;" id="btnFiltrar"><i class="fa-solid fa-filter"></i> Filtrar</button>
        </div>
    </div>
...
<div style="overflow: scroll; overflow-x: auto; height:350px; width:100%;" class="table-container">
    <table class="table table-striped table-hover table-head-fixed  text-nowrap table-sm  table-traslado" tyle="
                    font-size: 15px;
                    text-align: center;
        ...
        <thead>
            <tr>
                ...
                <th style="width: 300px;">Ubicación Origen</th>
...
<script>
    $(document).ready(function() {
        miDataTable4 = $('#tb-4').DataTable({
            ...
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/listmovinsumo/mostrar-4.php', // URL de tu archivo PHP que devuelve los datos
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        return '<span style="color:green;">' + full.bodegaorg + '</span>--' +
                            '<span style="color:blue;">' + full.standorg + '</span>--' +
                            '<span style="color:red;">' + full.entrepanioorg + '</span>';
                    }
                },
                {
                    "data": null,
