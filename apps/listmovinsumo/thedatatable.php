...
if ($conetar->connect_errno) {
    ...
    <body>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover table-head-fixed  text-nowrap table-sm table-tb" id="tb"
                style="width:100% !important;">
                <thead>
                    <tr>
                        <th style="text-align: center;">N° Traslado</th>
                        <th style="text-align: center;">Producto</th>
                        <th style="text-align: center;">Ubicacion Origen</th>
                        <th style="text-align: center;">Departamento Destino</th>
                ...
                <tbody>
                    <!-- Aquí puedes agregar filas con PHP si es necesario -->
                </tbody>
        ...
        <!-- Modal -->
        <div class="modal fade" id="modalPromedio" tabindex="-1" aria-labelledby="modalPromedioLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content" id="modalContent">
                    <div class="modal-header">
                        <h5 class="modal-title" id="modalPromedioLabel">Promedio de entregas</h5>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
                    <div class="modal-body" id="contentProm">
        ...
        <script>
            $(document).ready(function () {
                miDataTable = $('#tb').DataTable({
                    ...
                    "ajax": {
                        url: 'https://cw3.tierramontemariana.org/apps/listmovinsumo/mostrar.php',
                        type: 'GET',
                        dataType: 'json',
                        dataSrc: '',
                        data: function (d) {
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                return '<span style="color:green;">' + full.bodega + '</span>--' +
                                    '<span style="color:blue;">' + full.stand + '</span>--' +
                                    '<span style="color:red;">' + full.entrepanio + '</span>';
                            }
                        },
                        {
                        ...
                        },
                        {
                            ...
                            "render": function (data, type, full, meta) {
                                ...
                                return '<a href="#" title="Ver promedio" style="color:#213FD6;" onclick="loadProm(' + full.idproducto + ')" data-toggle="modal" data-target="#modalPromedio"><i class="fa-solid fa-eye" style="font-size:13px;"></i></a>';
                            }
                        }
                    ]
                });
            ...
            function loadProm(id) {
                $("#contentProm").load("https://cw3.tierramontemariana.org/apps/listmovinsumo/table-promedio.php", {
                    id: id
                });
            }
            ...
            function cargarDatos() {
                $.ajax({
                    url: 'https://cw3.tierramontemariana.org/apps/listmovinsumo/mostrar.php', // Página PHP que devuelve los datos en formato JSON
