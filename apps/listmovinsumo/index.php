...
<script>
    ...
    function cargarEntregas() {
        $("#v-pills-home").load("https://cw3.tierramontemariana.org/apps/listmovinsumo/thedatatable.php");
    }

    function cargarCompras() {
        $("#v-pills-profile").load("https://cw3.tierramontemariana.org/apps/listmovinsumo/thedatatable-2.php");
    }

    function cargarInventario() {
        $("#v-pills-messages").load("https://cw3.tierramontemariana.org/apps/listmovinsumo/thedatatable-3.php");
    }
    function cargarTraslados() {
        $("#v-pills-traslados").load("https://cw3.tierramontemariana.org/apps/listmovinsumo/thedatatable-4.php");
    }
</script>
