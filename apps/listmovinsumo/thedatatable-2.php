...
if ($conetar->connect_errno) {
    ...
    <body>
        ...
        <table class="table table-striped table-hover table-head-fixed  text-nowrap table-sm table-tb-2" id="tb-2"
        ...
        <script>
            $(document).ready(function () {
                miDataTable2 = $('#tb-2').DataTable({
                    ...
                    "ajax": {
                        url: 'https://cw3.tierramontemariana.org/apps/listmovinsumo/mostrar-2.php',
                        type: 'GET',
                        dataType: 'json',
                        dataSrc: '',
                        data: function (d) {
            ...
            function genPDF() {
                ...
                var oldPagination = tabla.page.len();
                tabla.page.len(-1).draw();

                // Eliminamos el retraso para asegurarnos de que DataTables haya renderizado completamente el contenido
                html2pdf().from(content).set(pdfOptions).outputPdf().then(function (pdf) {
                    ...
                    tabla.page.len(oldPagination).draw();
                });
            }
        </script>
