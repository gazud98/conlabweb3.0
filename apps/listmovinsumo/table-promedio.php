...
?>
    ...
    <body>
        <div class="row mb-4">
            <div class="col-md-12 col-lg-12">
                <div id="dt">
                    ...
                    border: 1px solid #aaa;
                    border-radius: 4px;height: 28px; background-color: rgb(0,69,165);color:white;font-size: 13px;" id="button-fil-2"><i class="fa-solid fa-filter"></i> Filtrar</button>
                </div>
            </div>
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover table-head-fixed  text-nowrap table-sm table-tb" id="tb-prom" style="width:100% !important;">
                <thead>
                    <tr>
        ...
        <script>
            $(document).ready(function() {
                miDataTableProm = $('#tb-prom').DataTable({
                    language: {
                    ...
                    "ajax": {
                        url: 'https://cw3.tierramontemariana.org/apps/listmovinsumo/mostrar-promedio.php?id=<?php echo $id; ?>',
                        type: 'GET',
                        dataType: 'json',
                        dataSrc: '',
                        data: function(d) {
                ...
                $('#button-fil-2').click(function() {
                    miDataTableProm.ajax.reload();
                });
            });
        </script>
