    ...
    <table class="table table table-striped   table-inventario" tyle="
        ...
        <thead>
            <tr>
                ...
                <th style="text-align: center !important;width:20%;">Producto</th>
...
<script>
    $(document).ready(function () {
        $('.table-inventario').DataTable({
            ...
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/listmovinsumo/mostrar-3.php', // URL de tu archivo PHP que devuelve los datos
