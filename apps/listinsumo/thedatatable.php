...
?>
    <table class="table table-striped table-hover table-head-fixed text-nowrap table-sm">
        ...
        <tbody>
            ...
            $cadena = "SELECT a.id_producto,a.nombre,a.id_unidadmedida,b.nombre as unidad,a.stckmin,a.stckmax,a.estado
            
                    FROM  u116753122_cw3completa.producto a,u116753122_cw3completa.unidad_medida b " .
                $filterfrom .
                " where 1=1 
                and a.id_unidadmedida = b.id_unidad_medida" .
                $filterwhere;
