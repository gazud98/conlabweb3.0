        ...
        <div class="col-md-12 col-lg-12 mb-9" style="width:95%;">
            ...
            <div class="card">
                <div class="card-header bg-white">
                    <label class="card-title" style="color: rgb(1,103,183);font-size: 13px;"><strong> PRODUCTOS EN BODEGAS</strong> </label>
                </div>
                <div class="row">

                        <div class="col-md-12 col-lg-12">
                        <!-- DISEÑO TABLA-->
                        <div style=" overflow-y:scroll; height:200px;width:auto;padding:8px;">
                    ...
                    <div class="row">
                        <div class="col-md-7 col-lg-7">
                            <div class="col-md-12">
                                <label class="card-title" style="color: rgb(1,103,183);font-size: 13px;"><strong> PRODUCTOS EN BODEGA PRINCIPAL</strong> </label>
                            </div>
                            <!-- DISEÑO TABLA-->
                            <div class="col-md-12" style=" overflow-y:scroll; height:300px;width:100%;">
                                <table class="table table-hover">
                                    <thead>
                                        <tr style="background-color: rgb(1,103,183);color:white;" height="4">
