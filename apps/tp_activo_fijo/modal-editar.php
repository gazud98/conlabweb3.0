...
if( file_exists("config/accesosystems.php")) {
 ...
 if ($conetar->connect_errno) {
    ...
    $cadena = "select P.id,P.nombre,P.estado,P.descripcion
    from cw3completa.tipo_activo_fijos P
   where P.id='" . $id . "'";
    //                     echo $cadena;
...
?>
    ...
    <div class="form-group">
        ...
        <input type="input" class="form-control" name="descripcion" id="descripcion" value="<?php echo $descripcion ?>">
    </div>
    </div>
    ...
    $(document).ready(function() {
        ...
        $.validator.setDefaults({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: '/cw3/apps/tp_activo_fijo/crud.php',
                ...
                $('.content-table-tp').load('/cw3/apps/tp_activo_fijo/thedatatable.php');
            }
        });
        $('#formeditar').validate({
            rules: {
