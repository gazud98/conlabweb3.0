...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="https://conlabweb3.tierramontemariana.org/apps/tp_activo_fijo/assets/style.css">
</head>
<style>
    .content-wrapper {
...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.content-table-tp_activo_fijo').load('https://conlabweb3.tierramontemariana.org/apps/tp_activo_fijo/table_view.php');
