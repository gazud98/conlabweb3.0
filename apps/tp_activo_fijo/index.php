...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="/cw3/conlabweb3.0/apps/tp_activo_fijo/assets/style.css">
</head>
<style>
    .content-wrapper {
...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.content-table-tp_activo_fijo').load('/cw3/conlabweb3.0/apps/tp_activo_fijo/table_view.php');
