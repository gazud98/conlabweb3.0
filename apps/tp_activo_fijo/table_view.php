...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm table responsive" style="width:100%;" id="table-tp_activo_fijo">
    <thead>
        <tr>
...
<script>
    function exportarExcel() {
        ...
        var tabla = document.getElementById('table-tp_activo_fijo');
    ...
    $(document).ready(function() {
        miDataTable = $('#table-tp_activo_fijo').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/tp_activo_fijo/show_data.php', // Página PHP que devuelve los datos en formato JSON
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, full, meta) {
                        ...
                        var borrarLink = '<a href="#" onclick="borrar(' + full.codigo + ');" style="color: #CE2222;" title="Eliminar"><i id="icon" style="font-size:13px;" class="fa-solid fa-trash-can"></i><span></span></a>';
        ...
        $.validator.setDefaults({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: 'https://conlabweb3.tierramontemariana.org/apps/tp_activo_fijo/crud.php',
                    ...
                    success: function(respuesta) {
                        if (respuesta == 1) {
                            Swal.fire({
                                icon: 'error',
                                title: 'Oops...',
                                text: '¡Este Tipo de Activo Fijo ya existe!',
                                footer: 'Crea un Tipo de Activo Fijo con un nuevo nombre'
                            })
                        } else {
                            Swal.fire({
                                position: 'top',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://conlabweb3.tierramontemariana.org/apps/tp_activo_fijo/process_data.php',
            dataType: 'json',
            data: {
                id: id
            },
