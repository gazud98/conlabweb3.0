    ...
    <script>
        $(document).ready(function() {
            miDataTable = $('.table-producto').DataTable({
                ...
                // ... Otras opciones ...
                "ajax": {
                    url: '/cw3/conlabweb3.0/apps/producto/mostrar.php', // Página PHP que devuelve los datos en formato JSON
        ...
        function deleteProduct(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: '/cw3/conlabweb3.0/apps/producto/delete.php?id=' + id,
                        success: function() {
                            Swal.fire(
                                '¡Eliminado!',
        ...
        function disableProduct(id, estado) {
            if (estado == 1) {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: '/cw3/conlabweb3.0/apps/producto/crud-2.php',
                            data: {
                                id: id,
                                aux: 2
                            },
        ...
        function cargarForm(thefile, id, tp) {
            if (tp == 'I') {
                $("#contentFormEditEquipo").load("/cw3/conlabweb3.0/apps/producto/productos.php", {
                    id: id
                });

            } else {
                $("#contentFormEditEquipo").load("/cw3/conlabweb3.0/apps/producto/equipos.php", {
                    id: id
                });
            }
        }
