...
?>
    ...
    <head>
        ...
        <title></title>
        <link rel="stylesheet" href="/cw3/conlabweb3.0/apps/producto/assets/style.css">
    ...
    <body>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#contentTableProdcutos').load('/cw3/conlabweb3.0/apps/producto/table.php');

            });

            function loadFormProdcut() {
                $('#contentFormProduct').load('/cw3/conlabweb3.0/apps/producto/productos.php');
            }

            function loadFormEquipo() {
                $('#contentFormEquipo').load('/cw3/conlabweb3.0/apps/producto/equipos.php');
            }
