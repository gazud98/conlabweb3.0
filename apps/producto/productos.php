...
?>
    ...
    <form name="formcontrol2" id="formcontrol2" action="" method="POST" enctype="multipart/form-data">
        ...
        <iframe id="form-up" style="width: 100%;border:none;overflow:hidden;margin-top:20px;" height="120" src="/cw3/conlabweb3.0/apps/producto/form-files.php?id=<?php echo $id ?>">
        </iframe>
    ...
    $(document).ready(function() {
        $.validator.setDefaults({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: '/cw3/conlabweb3.0/apps/producto/crud-2.php?aux=1',
