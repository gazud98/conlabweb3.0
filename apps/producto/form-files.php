...
<form action="https://cw3.tierramontemariana.org/apps/producto/subir_archivo.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data" style="
    width:100%;
     ">
    <div class="row">
...
<script>
    $(document).ready(function() {
        $('#show').load('https://cw3.tierramontemariana.org/apps/producto/show-files.php?id=<?php echo $id ?>');
        $('#showname').load('https://cw3.tierramontemariana.org/apps/producto/show-namefile.php?id=<?php echo $id ?>');
    });
</script>