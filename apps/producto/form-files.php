...
<form action="/cw3/conlabweb3.0/apps/producto/subir_archivo.php?id=<?php echo $id ?>" method="post" enctype="multipart/form-data" style="
    width:100%;
     ">
    <div class="row">
...
<script>
    $(document).ready(function() {
        $('#show').load('/cw3/conlabweb3.0/apps/producto/show-files.php?id=<?php echo $id ?>');
        $('#showname').load('/cw3/conlabweb3.0/apps/producto/show-namefile.php?id=<?php echo $id ?>');
    });
</script>