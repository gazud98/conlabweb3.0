...
?>
    ...
    <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/consultamantenimiento/assets/style.css">
    ...
    <script>
        ...
        function sendResultado() {
            ...
            $.ajax({
                type: 'POST',
                url: 'https://cw3.tierramontemariana.org/apps/consultamantenimiento/send-result.php',
                ...
                success: function(rest) {
                    ...
                    data.forEach(element => {
                        ...
                        window.open('https://cw3.tierramontemariana.org/apps/consultamantenimiento/generar-reporte.php?id=' +
        ...
        function setMotivo() {
            $.ajax({
                type: 'POST',
                url: 'https://cw3.tierramontemariana.org/apps/consultamantenimiento/crud.php?aux=1',
                ...
                success: function(respuesta) {
                    ...
                    $('#loadMotivo').load('https://cw3.tierramontemariana.org/apps/consultamantenimiento/load-motivo.php');
                }
            });
        }
