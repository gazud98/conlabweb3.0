...
if ($conetar->connect_errno) {
    ...
    $cadena = "SELECT a.idbodegaentrapanio,a.idproducto,a.identrepanio,d.id as idstand,e.id as idbodega,c.nombre as entrepanio,d.nombre as stand,e.nombre as bodega,a.fchvence, SUM(a.cant_recibida) as cant,b.nombre,b.referencia ,@row_number := @row_number + 1 as numero_file
    ...
    WHERE a.identrepanio <> 0 AND a.cant_recibida <> 0 AND b.referencia like '%".$id_prodc."%' GROUP BY a.fchvence,a.identrepanio HAVING cant <> 0 ORDER BY  numero_file ASC";
