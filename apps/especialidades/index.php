...
if ($conetar->connect_errno) {
    ...
    if ($id != "") {
        $cadena = "select P.id ,P.descripcion,P.estado
                    from u116753122_cw3completa.especialidades P
                    where P.id='" . $id . "'";
        //                     echo $cadena;
    ...
    <body>
                        ...
                        <div class="col-md-4">
                            <div class="">
                                <nav class="breadcrumbs">
                                    ...
                                    <a href="#" class="breadcrumbs__item is-active" style="text-decoration: none;">Especialidad</a>
                                </nav>
                    ...
                    <form name="formcontrol" id="formcontrol" action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>Nombre:</label>
                                <input type="input" class="form-control" name="descripcion" id="descripcion" required>
                            </div>
                        <!--    <div class="form-group">
        ...
        <div id="editModal" class="modal fade">
            <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Editar Especialidad</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>
                    <form id="formeditar" action="#" method="POST" enctype="multipart/form-data">
                        <div class="modal-body" id="modalEditEsp">
