...
if ($conetar->connect_errno) {
    ...
    if ($modeeditstatus == "D") { //es de desahibilitar/habikitr
        ...
        $cadena = "select estado from u116753122_cw3completa.especialidades where id='" . $id . "'";
        ...
        $cadena = "update u116753122_cw3completa.especialidades set estado='" . $estado . "' where id='" . $id . "'";
        ...
        if ($modeeditstatus == "C") { ////CREACION
            $cadena = "insert into u116753122_cw3completa.especialidades(descripcion,estado)values('" . $nombre . "',1)";
            $resultado = mysqli_query($conetar, $cadena);
            ...
            if ($modeeditstatus == "E") { //acgualzucsion
                $cadena = "update u116753122_cw3completa.especialidades set
                                descripcion='" . $nombre . "'
                            where id='" . $id . "'";
                $resultado = mysqli_query($conetar, $cadena);
                ...
                if ($modeeditstatus == "B") { //acgualzucsion
                    $cadena = "DELETE FROM u116753122_cw3completa.especialidades where id='" . $id . "'";
                    $resultado = mysqli_query($conetar, $cadena);
                }
            }
        } //De es insetar
