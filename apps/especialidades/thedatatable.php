...
?>
    ...
    <table class="table table-striped" id="table-unidad_medida" style="
                    font-size: 15px;
                    text-align: center;
                    margin-top: 150px;
                ">
        ...
        <tbody>
            ...
            $cadena = "SELECT id, descripcion, estado
                    FROM  u116753122_cw3completa.especialidades order by 1 ";
            //                      echo $cadena;
            /* */
    ...
    <script>
        ...
        function editar(id) {
            ...
            $('#modalEditEsp').load('https://cw3.tierramontemariana.org/apps/especialidades/modal-editar.php', {
                id: id
            });
