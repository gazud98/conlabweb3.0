...
// //echo base_url.'.......<br>'.'...'.hostname.','.db_login.','.db_pass.','.bbserver1.'----<br>';
 ...
 include('reglasdenavegacion.php');
   ...
   // echo $caso.'----'.$id;
    ...
    $cadena="select id, nombre,cantidad,fecha,motivo,costo,no_factura,estado
                from u116753122_cw3completa.insumo_devueltosproveedor
                where id='".$id."'";
    ...
    if($numerfiles2>=1){
        ...
        $no_factura=trim($filaP2['no_factura']);
...
?>
            <div class=" bg-light col-md-12 col-lg-12 p-2" name="accionejec" id="accionejec"
                ...
                <div class="col-md-12 col-lg-12 p-3" name="iddatas" id="iddatas" style="pointer-events: none;background-color:#ededed;">
                    ...
                    <div class="row" name="casoesperado" id="casoesperado"><?php include('datacase1.php');  //campos de la app ?></div><?php //aqui va el caso a mostrar segun seleccion del caso encontrado ?>
                </div>
