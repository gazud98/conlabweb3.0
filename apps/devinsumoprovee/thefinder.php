            ...
            <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <input type="input" class="form-control" name="fndcantidad" id="fndcantidad" style="width: 100%; height: 28px;font-size: 12px;"></input>
                            </div>
                            <div class="col-md-12 col-lg-12">
                                <label style="font-size: 12px;">No. Factura</label>
                                <input type="input" class="form-control" name="fndfactura" id="fndfactura" style="width: 100%; height: 28px;font-size: 12px;"></input>
                            </div>
                            <div class="col-md-12 col-lg-12">
                                <label style="font-size: 12px;">Fecha</label>
                                <input type="input" class="form-control" name="fndfecha" id="fndfecha" style="width: 100%; height: 28px;font-size: 12px;"></input>
                            </div>
                        </div>
...
<script>
    function generafilters(){
        ...
        var fndcantidad=$("#fndcantidad").val();
        var fndfecha=$("#fndfecha").val();
        var fndfactura=$("#fndfactura").val();
      //  alert(fndnombre);
        ...
        $.ajax({
            ...
            data : {
                    fndcodigo:fndcodigo,
                    fndnombre:fndnombre,
                    fndcantidad:fndcantidad,
                    fndfecha:fndfecha,
                    fndfactura:fndfactura
                    },
