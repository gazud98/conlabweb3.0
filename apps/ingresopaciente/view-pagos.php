...
<script>
    $(document).ready(function() {
        ...
        miDataTablePago = $('#tableDetallePago').DataTable({
            ...
            "responsive": false,
            "ajax": {
                url: '/cw3/conlabweb3.0/apps/ingresopaciente/get-pago.php?numorden=<?php echo $num_orden; ?>', // Página PHP que devuelve los datos en formato JSON
    ...
    $(document).ready(function() {
        $.validator.setDefaults({
            submitHandler: function() {
                ...
                $.ajax({
                    type: 'POST',
                    url: '/cw3/conlabweb3.0/apps/ingresopaciente/send-pago.php',
    ...
    function setDetallePago() {
        $.ajax({
            type: 'POST',
            url: '/cw3/conlabweb3.0/apps/ingresopaciente/set-detalle-pago.php',
