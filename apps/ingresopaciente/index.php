...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/cw3/conlabweb3.0/apps/ingresopaciente/assets/style.css">
</head>
...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#search-patient").load("/cw3/conlabweb3.0/apps/ingresopaciente/search.php", {
                user: <?php echo $user ?>
            });
