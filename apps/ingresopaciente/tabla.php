...
<script>
    $(document).ready(function() {
        ...
        miDataTable = $('.tabla-examen').DataTable({
            ...
            "responsive": false,
            "ajax": {
                url: '/cw3/conlabweb3.0/apps/ingresopaciente/tabla-examen.php', // Página PHP que devuelve los datos en formato JSON
    ...
    function agregarExamen() {
        $.ajax({
            type: 'POST',
            url: '/cw3/conlabweb3.0/apps/ingresopaciente/agregar-paciente.php',
            data: $('#form-examen').serialize(),
            success: function(data) {
                // Recargar DataTable con nuevos datos
                miDataTable.ajax.reload();
                $('#pagos').load('/cw3/conlabweb3.0/apps/ingresopaciente/view-pagos.php', {
    ...
    $('#contentModalDomicilios').load('/cw3/conlabweb3.0/apps/ingresopaciente/modal-domicilios.php', {
