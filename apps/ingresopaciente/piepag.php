    ...
    <?php if($nocreatebittomP!="S") { ?>
        ...
        <div class="col-md-6 col-xs-6 "  style="text-align:right;"   >
                ...
                <table>
                    <tr>
                        <td>
                            <button type="button" class="btn btn-primary btn-xs" name="newbtn" id="newbtn"  onclick="collapseanshow('C')" style="display:none">
                        ...
                        <td>
                            <button type="button" class="btn btn-success btn-xs" name="successbtn" id="successbtn"  onclick="collapseanshow('A')" style="display:none">
                                <i class="fas fa-plus"></i>&nbsp;&nbsp;Aceptar
                            </button>
                        </td>
                        <td>
                            <button type="button" class="btn btn-warning btn-xs" name="cancelbtn" id="cancelbtn"  onclick="collapseanshow('X')" style="display:none">
                                <i class="fas fa-pen"></i>&nbsp;&nbsp;Cancelar
                            </button>
                        </td>
                    </tr>
                </table>
