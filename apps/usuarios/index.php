...
?>
    ...
    <head>
        ...
        <title></title>
        <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/usuarios/assets/style.css">
    </head>
    ...
    <body>
        ...
        <script>
            ...
            function loadFormUsers() {
                $('#conetentFormUsers').load('https://cw3.tierramontemariana.org/apps/usuarios/datacase1.php');
            }

            function loadFormEditUsers(id, id_rol) {

                $('#conetentFormEditUsers').load('https://cw3.tierramontemariana.org/apps/usuarios/modal-editar.php', {
                    id: id,
                }, function(){
            ...
            $(document).ready(function() {
                ...
                $('#thetable').load('https://cw3.tierramontemariana.org/apps/usuarios/thedatatable.php');
