...
?>
    ...
    <form name="formUpdate" id="formUpdate" action="" method="POST" enctype="multipart/form-data" style="width: 100%;">
...
<script>
    ...
    $(document).ready(function() {
        ...
        $.validator.setDefaults({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: '/cw3/conlabweb3.0/apps/usuarios/crud.php?aux=2',
                    ...
                    success: function(respuesta) {
                        if (respuesta == 1) {
                            ...
                            cargarDatos();
                            $('#nombre').val('');
                            $("#codigo").load('/cw3/conlabweb3.0/apps/usuarios/codigo.php');
    ...
    function savedata() {
        $.ajax({
            type: 'POST',
            url: '/cw3/conlabweb3.0/apps/usuarios/crud.php',
    ...
    function consultarDatos() {
        ...
        $("#infempleado").load("/cw3/conlabweb3.0/apps/usuarios/inf_empleados.php", {
            documento: documento,
            t_iden: t_iden
        });
