...
if ($conetar->connect_errno) {
    ...
    if ($modeeditstatus == "D") { //es de desahibilitar/habikitr
        ...
        $cadena = "select estado from u116753122_cw3completa.tp_vias where id='" . $id . "'";
        ...
        $cadena = "update u116753122_cw3completa.tp_vias set estado='" . $estado . "' where id='" . $id . "'";
        ...
        if ($modeeditstatus == "C") { ////CREACION
            $cadena = "insert into u116753122_cw3completa.tp_vias(nombre,estado)values('" . $nombre . "',1)";
            $resultado = mysqli_query($conetar, $cadena);
            ...
            if ($modeeditstatus == "E") { //acgualzucsion
                $cadena = "update u116753122_cw3completa.tp_vias set
                                nombre='" . $nombre . "'
                            where id='" . $id . "'";
                $resultado = mysqli_query($conetar, $cadena);
                ...
                if ($modeeditstatus == "B") { //acgualzucsion
                    $cadena = "DELETE FROM u116753122_cw3completa.tp_vias where id='" . $id . "'";
                    $resultado = mysqli_query($conetar, $cadena);
                }
            }
        } //De es insetar
