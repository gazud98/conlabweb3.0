...
?>
    ...
    <head>
        ...
        <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/citas/assets/style.css">
    ...
    <body>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#modalContent').load('https://cw3.tierramontemariana.org/apps/citas/modal-new-cita.php')
            ...
            $(document).ready(function() {
                ...
                var calendar = new FullCalendar.Calendar(calendarEl, {
                    ...
                    events: 'https://cw3.tierramontemariana.org/apps/citas/obtener_datos.php',
            ...
            function loadFormsAddContact() {
                $('.content-add-contact').load('https://cw3.tierramontemariana.org/apps/citas/modal-contact.php')
            }

            function loadFormsEditCita(id) {
                $('.content-edit-cita').load('https://cw3.tierramontemariana.org/apps/citas/edit-cita.php', {
                    id: id
                })
            }
            ...
            function searchCita() {
                ...
                if (nombre != "" || fecha != "") {
                    $('#modalSearch').modal();
                    $('.content-table-search').load('https://cw3.tierramontemariana.org/apps/citas/modal-search.php', {
                        nombre: nombre,
                        fecha: fecha
                    })
                } else {
