...
//          si estadio es 1 pasa ra 0 o v iceversa
        ...
        $result="ok";
            ...
            $codinstrumento=trim(htmlspecialchars($_REQUEST['codinstrumento']));
        
            $actividades=trim(htmlspecialchars($_REQUEST['actividades']));
          
            $fecha=trim(htmlspecialchars($_REQUEST['fecha']));
            $resultado=trim(htmlspecialchars($_REQUEST['resultado']));
           


            if($modeeditstatus=="C"){////CREACION
                $cadena="insert into u116753122_cw3completa.mantenimiento(id_actividad,id_instrumento,fecha,resultado,estado)values('".
                        $actividades.
                        "','".$codinstrumento.
                        "','".$fecha.
                        "','".$resultado.
