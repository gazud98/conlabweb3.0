...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm" id="table-categorias" style="
                    font-size: 15px;
                    text-align: center;
...
<script>
    function exportarExcel() {
        ...
        var tabla = document.getElementById('table-categorias');
    ...
    $(document).ready(function() {
        miDataTable = $('#table-categorias').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: '/cw3/conlabweb3.0/apps/categorias/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: '/cw3/conlabweb3.0/apps/categorias/crud.php',
                    ...
                    success: function(respuesta) {
                        if (respuesta == 1) {
                            Swal.fire({
                                ...
                                footer: 'Crea una categoria con un nuevo nombre'
                            })
                        } else {
                            Swal.fire({
                                position: 'top',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: '/cw3/conlabweb3.0/apps/categorias/process_data.php',
            data: {
                id: id
            },
            dataType: 'json',
