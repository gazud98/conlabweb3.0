...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/categorias/assets/style.css">
</head>
<style>
    .content-wrapper {
...
<body>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.content-table-unidad_medida').load('https://cw3.tierramontemariana.org/apps/categorias/table_view.php');
