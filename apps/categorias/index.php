...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="https://conlabweb3.tierramontemariana.org/apps/categorias/assets/style.css">
</head>
<style>
    .content-wrapper {
...
<body>
        ...
        <div class="card-header bg-light ">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    <h5 style="text-align: center; color: #0045A5;"><strong>Listado de Categorias</strong></h5>
                </div>
                <div class="col-md-4 text-right">


                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal" style="font-size:11px;background-color: rgb(0,69,165);border:none;"><i class="fas fa-plus"></i>&nbsp;&nbsp;Nueva Categoria</button>
                </div>
            </div>
        </div>
        <div class="card-body">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.content-table-unidad_medida').load('https://conlabweb3.tierramontemariana.org/apps/categorias/table_view.php');
