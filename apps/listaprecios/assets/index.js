$(document).ready(function() {
    ...
    $('.content-table-examenes').load('/cw3/conlabweb3.0/apps/listaprecios/table-examen.php');
    $('.content-table-precio-examenes').load('/cw3/conlabweb3.0/apps/listaprecios/table-lista-examen.php');
    $('.content-detalle-lista').load('/cw3/conlabweb3.0/apps/listaprecios/table-detalle-lista.php');
...
function viewTotalExamenes(){
    $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/listaprecios/mostrar.php?aux=4',
...
function moverDatos() {
    ...
    for (var i = 0; i < box.length; i++) {
        if (box[i].checked) {
            ...
            fetch('/cw3/conlabweb3.0/apps/listaprecios/procesar.php', {
                method: 'POST',
                body: formData
            })
...
function setDetalleLista() {
    ...
    $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/listaprecios/crud.php?aux=8',
...
function updateProcentaje() {
    ...
    if (checkboxesSeleccionados === totalCheckboxes) {
        $.ajax({
            type: 'POST',
            url: '/cw3/conlabweb3.0/apps/listaprecios/crud.php?aux=5',
            data: {
        ...
        $.ajax({
            type: 'POST',
            url: '/cw3/conlabweb3.0/apps/listaprecios/crud.php?aux=6',
            data: {
                frecuencia: frecuencia,
                procentaje: procentaje,
        ...
        fetch('/cw3/conlabweb3.0/apps/listaprecios/crud.php?aux=7', {
            method: 'POST',
            body: formData2
        })
            .then(response => response.json())
...
function deleteDetalleLista(ide, ide2) {
    ...
    Swal.fire({
        ...
        $.ajax({
            type: 'POST',
            url: '/cw3/conlabweb3.0/apps/listaprecios/crud.php?aux=9',
            data: {
                ide: ide
            },
            success: function (respuesta) {
...
function grabador(id) {
    ...
    $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/listaprecios/crud.php?aux=4',
        data: {
            id: id,
...
function viewTotalExamenesLista(id){
    $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/listaprecios/mostrar.php?aux=5',
        data: {
            id: id
        },
        success: function (res) {
