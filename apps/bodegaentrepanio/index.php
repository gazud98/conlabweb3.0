...
?>
    ...
    <head>
        ...
        <title></title>
        <link rel="stylesheet" href="/cw3/conlabweb3.0/apps/bodegaentrepanio/assets/style.css">
    </head>
    <style>
        .content-wrapper {
    ...
    <body>
        ...
        <script>
            function agregar(sel) {
                ...
                $("#stands").load("/cw3/conlabweb3.0/apps/bodegaentrepanio/stands.php", {
                    id: id
                });
            ...
            $(document).ready(function() {
                ...
                $('.content-table-bodegaentrepanio').load('/cw3/conlabweb3.0/apps/bodegaentrepanio/table_view.php');
