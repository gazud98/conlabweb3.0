...
?>
    ...
    <table class="table table-striped table-sedes" style="
                    font-size: 15px;
                    text-align: center;
                    margin-top: 150px;
                ">
        ...
        <tbody>
            ...
            apellido_2, fecha_nacimiento, direccion, telefono, movil, ciudad, departamento, estado, id_tipo_genero 
            ...
            ?>
                    ...
                    <tr>
                        <!--<td name="thefileselected<?php echo trim($thefile); ?>" id="thefileselected<?php echo trim($thefile); ?>"><?php echo $id_medicos; ?></td>-->
                        <td>
                            <?php echo $documento; ?>
                        </td>
                        <td>
                            <?php echo $nombre_1 .' ' . $nombre_2 . ' ' . $apellido_1 . ' ' . $apellido_2; ?>
                        </td>
                        <td>
                            <?php 
                        ...
                        <td>
                            <?php echo $direccion.', '.$ciudad.', '.$departamento; ?>
                        </td>
                        <td>
                            <?php
                            if ($estado == "0") {
                        ...
                        <td>
                            <a href="#" onclick="editar(<?php echo $id_pacientes; ?>);" data-target="#editsedeModal" data-toggle="modal" style="color: #E8A200;" title="Editar"><i style="font-size:18px;" id="icon" class="fa-solid fa-pen-to-square"></i><span></span></a>
                            <a href="#" onclick="borrar(<?php echo $id_pacientes; ?>);" data-toggle="modal" style="color: #CE2222;" title="Eliminar"><i id="icon" style="font-size:18px;" class="fa-solid fa-trash-can"></i><span></span></a>
                            <a href="#" onclick="desactivar(<?php echo $id_pacientes; ?>,<?php echo $estado ?>);" style="color: #061078;" title="Desactivar"><i id="icon" style="font-size:18px;" class="fa-solid fa-power-off"></i><span></span></a>
                        </td>
                    </tr>
    ...
    <script>
        ...
        function editar(id) {
            ...
            $('.cargar-campos').load('https://cw3.tierramontemariana.org/apps/pacientes/modal-editar.php', {
                id: id
            });
