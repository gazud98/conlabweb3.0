...
if ($conetar->connect_errno) {
    ...
    if ($modeeditstatus == "D") {
        ...
        $cadena = "select estado from u116753122_cw3completa.pacientes where id_pacientes='" . $id . "'";
        ...
        $cadena = "update u116753122_cw3completa.pacientes set estado='" . $estado . "' where id_pacientes='" . $id . "'";
        ...
        if ($modeeditstatus == "C") {
            ...
            $cadena = "insert into u116753122_cw3completa.pacientes(
                ...
                movil, ciudad,departamento, estado
               )values('" .
                $id_tipo_identificacion . "','" . $documento . "','" .
                $nombre_1 . "','" . $nombre_2 . "','" . $apellido_1 . "','" . $apellido_2 . "','" .
                $id_tipo_genero . "','" . $fecha_nacimiento . "','" . $direccion . "','" . $telefono . "','" .
            ...
            if ($modeeditstatus == "E") {
                $cadena = "UPDATE u116753122_cw3completa.pacientes SET
                ...
                if ($modeeditstatus == "B") {
                    $cadena = "DELETE FROM u116753122_cw3completa.pacientes where id_pacientes='" . $id . "'";
                    $resultado = mysqli_query($conetar, $cadena);
                }
            }
        }
