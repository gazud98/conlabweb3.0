...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm" id="table-bodegastand" style="
                    font-size: 15px;
                    text-align: center;
...
<script>
    function exportarExcel() {
        ...
        var tabla = document.getElementById('table-bodegastand');
    ...
    $(document).ready(function() {
        miDataTable = $('#table-bodegastand').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: '/cw3/conlabweb3.0/apps/bodegastand/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: '/cw3/conlabweb3.0/apps/bodegastand/crud.php',
                    ...
                    success: function(respuesta) {
                        if (respuesta == 1) {
                            Swal.fire({
                                icon: 'error',
                                title: 'Oops...',
                                text: '¡Este Estante ya existe!',
                                footer: 'Crea un Estante con un nuevo nombre'
                            })
                        } else {
                            Swal.fire({
                                position: 'top',
    ...
    function editar(id) {
        ...
        $('#modalshow').load('/cw3/conlabweb3.0/apps/bodegastand/modal-editar.php', {
            id: id
        });
