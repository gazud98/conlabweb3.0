...
<script>
    ...
    $(document).ready(function() {
        miDataTable = $('#table-bodegastand').DataTable({
            ...
            "responsive": true,
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/bodegastand/show_data.php', // Página PHP que devuelve los datos en formato JSON
    ...
    function editar(id) {
        ...
        $('#modalshow').load('https://conlabweb3.tierramontemariana.org/apps/bodegastand/modal-editar.php', {
            id: id
        });
