...
<script>
    ...
    function updateCant(thefile, id, id_det) {
        ...
        $.ajax({
            type: 'POST',
            url: '/cw3/conlabweb3.0/apps/cotizacion/actualizarcant.php',
            data: {
                cantm: cantm,
                id: id_det
            },
    ...
    function selectthefile(thefile) {
        ...
        /*   $("#btndtl").load("/cw3/conlabweb3.0/apps/cotizacion/eliminar.php", {
               id_cot1: id_cot1,
    ...
    function previa() {
        ...
        $("#modalshow").load("/cw3/conlabweb3.0/apps/cotizacion/modal-2.php", {
            datos: datosJSON,
            id_req: id_req
        });
    ...
    function ejecutarOrdenes(id_req, id_proveedor) {
        ...
        $.ajax({
            type: 'POST',
            url: '/cw3/conlabweb3.0/apps/cotizacion/generadocotizacion.php',
            data: {
                id_req: id_req
            },
            success: function (data) {
    ...
    function sendMail() {
        $.ajax({
            method: 'POST',
            url: '/cw3/conlabweb3.0/apps/cotizacion/send_mail.php',
            success: function (respuesta) {
