...
?>
    ...
    <div class="content-regfical">
        ...
        <section class="p-3 col-md-12">
            <div class="row pb-2 mt-3 card card-body table-config-iva" style="width:80%;margin:auto;overflow-x: scroll;">
    ...
    <script>
        ...
        function buscarData2(id) {
            $.ajax({
                url: '/cw3/conlabweb3.0/apps/configregimenfiscal/search-3.php?id=' + id,
