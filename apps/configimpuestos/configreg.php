...
?>
    ...
    <div class="content-regfical">
        ...
        <section class="p-3 col-md-12">
            <div class="row pb-2 mt-3 card card-body table-config-reg" style="width:80%;margin:auto;overflow-x: scroll;">
    ...
    <script>
        ...
        function buscarData1(id){
            $.ajax({
                url: 'https://cw3.tierramontemariana.org/apps/configregimenfiscal/search-1.php?idreg='+id,
