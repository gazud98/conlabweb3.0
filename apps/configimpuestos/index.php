...
?>
    ...
    <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/configimpuestos/assets/style.css">
    ...
    <script>
        ...
        $('#form-control4').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'https://cw3.tierramontemariana.org/apps/configregimenfiscal/crud-4.php',
        ...
        $('#form-control3').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'https://cw3.tierramontemariana.org/apps/configregimenfiscal/crud-3.php',
        ...
        $('#form-control2').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'https://cw3.tierramontemariana.org/apps/configregimenfiscal/crud-2.php',
                ...
                success: function(respuesta) {
                    ...
                    $('.table-config-reg').load('https://cw3.tierramontemariana.org/apps/configregimenfiscal/tabla-2.php');
                    $('#regfiscal').val('');
                    $('#idreg').val('');
                }
            });
        ...
        $('#form-control').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: 'https://cw3.tierramontemariana.org/apps/configregimenfiscal/crud.php',
                ...
                success: function(respuesta) {
                    ...
                    $('.content-table-config').load('https://cw3.tierramontemariana.org/apps/configregimenfiscal/tabla.php');
                    $('#cuentacontable').val("");
                    $('#nombrecu').val("");
                    $('#valoruvt').val("");
                    $('#basepesos').val("");
        ...
        function deleteConfig1(id, aux) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        url: 'https://cw3.tierramontemariana.org/apps/configregimenfiscal/delete.php?aux=' + aux + '&id=' + id,
                        success: function(respuesta) {
