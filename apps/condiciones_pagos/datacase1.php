    ...
    function savedata() {
        $.ajax({
            ...
            success: function(respuesta) {
                ...
                $("#codigo").load('https://cw3.tierramontemariana.org/apps/condiciones_pagos/codigo.php');
                $("#thetable").load('https://cw3.tierramontemariana.org/apps/condiciones_pagos/thedatatable.php',{});
            }
        });
