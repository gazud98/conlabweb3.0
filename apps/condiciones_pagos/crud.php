...
if ($conetar->connect_errno) {
    ...
    if ($modeeditstatus == "D") { //es de desahibilitar/habikitr
        ...
        $cadena = "select estado from u116753122_cw3completa.condicion_pago where id='" . $id . "'";
        ...
        $cadena = "update u116753122_cw3completa.condicion_pago set estado='" . $estado . "' where id='" . $id . "'";
        ...
        if ($modeeditstatus == "C") { ////CREACION
            $consulta = "SELECT numero FROM u116753122_cw3completa.condicion_pago WHERE numero = '$numero'";
            $resultado = mysqli_query($conetar, $consulta);
            if (mysqli_num_rows($resultado) > 0) {
                $respuesta = 1;
                echo $respuesta;
            } else {
                $cadena = "insert into u116753122_cw3completa.condicion_pago(nombre,numero,estado)values('" . $nombre . "','" . $numero . "',1)";
                $resultado = mysqli_query($conetar, $cadena);
            }
            ...
            if ($modeeditstatus == "E") { //acgualzucsion
                $cadena = "update u116753122_cw3completa.condicion_pago set
                                nombre='" . $nombre . "',
                                numero='" . $numero . "'
                            where id='" . $id . "'";
                $resultado = mysqli_query($conetar, $cadena);
                ...
                if ($modeeditstatus == "B") { //acgualzucsion
                    $cadena = "DELETE FROM u116753122_cw3completa.condicion_pago where id='" . $id . "'";
                    $resultado = mysqli_query($conetar, $cadena);
                }
            }
        } //De es insetar
