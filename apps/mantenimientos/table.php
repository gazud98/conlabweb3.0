...
<script>
    ...
    function cargarForm(thefile, id) {
        ...
        if (tm == 'C') {
            $("#textFieldsEdit").load("/cw3/conlabweb3.0/apps/mantenimientos/edit-correctivo.php", {
                id: id
            });
            $('#titleEdit').html('Mantenimiento Correctivo');
        } else {
            $("#textFieldsEdit").load("/cw3/conlabweb3.0/apps/mantenimientos/edit-preventivo.php", {
                id: id
            });
