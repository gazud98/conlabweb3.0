...
if ($conetar->connect_errno) {
    ...
    $cadena = "select valor from cw3completa.configuracion where id=1";
   ...
   $cadenax = "insert into cw3completa.proveedores_archivo(idproveedor,descripcion,ruta,nombre_archivo)values('". $idp . "','" . $descrip . "','" . $ruta . "','" . $nombrefile . "')";
