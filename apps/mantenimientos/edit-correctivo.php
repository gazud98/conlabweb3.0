...
?>
    ...
    <form name="formEditCor" id="formEditCor" action="" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <input type="input" class="form-control" name="accidentada" id="accidentada" value="<?php echo $accidentada; ?>"></input>
    ...
    <script>
        ...
        function updateMantCor() {
            $.ajax({
                type: 'POST',
                url: 'https://conlabweb3.tierramontemariana.org/apps/mantenimientos/crud-2.php?aux=2',
                data: $('#formEditCor').serialize(),
                success: function() {
