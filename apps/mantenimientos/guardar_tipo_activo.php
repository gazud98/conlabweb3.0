...
if ($conetar->connect_errno) {
    ...
    if ($id <> 0 and $tipo_activo <>  0 ) {
        ...
        $cadena = "insert into cw3completa.tipo_activo_proveedor( id_proveedor,id_tipo_activo)values(
        '" . $id .
            "','" . $tipo_activo .
            "')";
    ...
    <table class="table table-striped table-hover table-head-fixed text-nowrap table-sm">
        ...
        <tbody>
            ...
            $cadena = "SELECT a.id,a.nombre
                          FROM  cw3completa.tipo_activo_fijos a, cw3completa.tipo_activo_proveedor b
