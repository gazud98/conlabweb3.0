        ...
        <div id="contentCorrectivo">
            <div class="row mt-2">
                <div class="col-md-3">
                    ...
                    <input type="text" name="danio" id="danio" class="form-control" required value="<?= $danio ?>">
                </div>
                <div class="col-md-3">
                    <label for="">Acción tomada:</label>
                    <input type="text" name="accion" id="accion" class="form-control" required value="<?= $accion ?>">
                </div>
                <div class="col-md-2">
