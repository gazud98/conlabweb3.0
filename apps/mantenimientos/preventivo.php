...
?>
    ...
    <!--<div class="p-2" style="text-align: center;">
        <h5><strong>Mantenimiento Preventivo</strong></h5>
        <hr>
    </div>-->
    ...
    <!--<div class="card-footer mt-5 text-center" style="border-radius: 5px;">
            <button type="button" class="btn btn-sm btn-success " name="btnsave" id="btnsave" onclick="savedata()" style="font-size:12px;width:90px;">
                <i class="fas fa-plus"></i>&nbsp;&nbsp;Grabar
            </button>
            <button type="button" class="btn btn-sm btn-danger " name="btncancel" id="btncancel" onclick="cancelNew()" style="font-size:12px;width:90px;">
