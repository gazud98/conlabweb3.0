...
$url = 'https://cw3.tierramontemariana.org/apps/mantenimientos/datacase1.php';
        ...
        <div class="col-md-6 col-xs-6 " style="text-align:right;">
            ...
            <table>
                <tr>
                    ...
                    <!--<td>
                        <button type="button" class="btn btn-success btn-xs" name="successbtn" id="successbtn" style="display:none" onclick="executeMaintenance()">
                            <i class="fas fa-plus"></i>&nbsp;&nbsp;Aceptar
                        </button>
                    </td>
                    <td>
                        <button type="button" class="btn btn-danger btn-xs" name="cancelbtn" id="cancelbtn" onclick="cancelNew()" style="display:none">
