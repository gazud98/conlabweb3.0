            ...
            <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 col-lg-12">
                                ...
                                <input type="input" class="form-control" name="fndnit" id="fndnit" style="width: 100%; height: 28px;font-size: 12px;"></input>
                            </div>
                            <div class="col-md-12 col-lg-12">
                                <label style="font-size: 12px;">Nombre</label>
                                <input type="input" class="form-control" name="razon_social" id="razon_social" style="width: 100%; height: 28px;font-size: 12px;"></input>
                            </div>
...
<script>
    function generafilters(){
        ...
        var nombre_1=$("#razon_social").val();
        var fndnit=$("#fndnit").val();
