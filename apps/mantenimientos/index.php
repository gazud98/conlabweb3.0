...
?>
    ...
    <script>
        function loadFormPrev() {
            $('#textFieldsPrev').load('https://cw3.tierramontemariana.org/apps/mantenimientos/preventivo.php');
        }

        function loadFormCor() {
            $('#textFieldsCor').load('https://cw3.tierramontemariana.org/apps/mantenimientos/correctivo.php');
        }
        ...
        function cancelNew() {
            ...
            $("#casoesperado").load('https://cw3.tierramontemariana.org/apps/mantenimientos/datacase1.php')
        }
    </script>
<?php
}
