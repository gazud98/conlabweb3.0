...
?>
    ...
    <script>
        function changeMaintenance(sel) {
            ...
            if (tm == 'C') {
                $("#choose-maintenance").load("/cw3/conlabweb3.0/apps/mantenimientos/correctivo.php", {
                    status: status
                });
            } else if (tm == 'P') {
                $("#choose-maintenance").load("/cw3/conlabweb3.0/apps/mantenimientos/preventivo.php", {
                    status: status
                });
            }
