...
<script>
    $(document).ready(function() {
        ...
        miDataTable = $('#table-solicitud').DataTable({
            ...
            // ... Otras opciones ...
            "ajax": {
                url: '/cw3/conlabweb3.0/apps/ordrequisicion/mostrar.php', // Página PHP que devuelve los datos en formato JSON
    ...
    if (datos == 1) {
        $("#btnreq").load('/cw3/conlabweb3.0/apps/ordrequisicion/orden.php');
    }
    ...
    function aprobarOrden(thefile, id) {
        ...
        $.ajax({
            type: 'POST',
            url: '/cw3/conlabweb3.0/apps/ordrequisicion/aprobarorden.php',
            data: {
                iduser: iduser,
                cantm: cantm,
                idsol: id
