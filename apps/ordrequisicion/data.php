...
<script>
    ...
    function seleccionar(sel) {
        ...
        if (typeof idx !== 'undefined' && idx !== null && idx !== '') {
            ...
            $("#val").load('https://cw3.tierramontemariana.org/apps/ordrequisicion/validator.php', {
                idx: idx,
                nom_insumo: nom_insumo,
                iduser: iduser
            });

            $("#cantbodega").load('https://cw3.tierramontemariana.org/apps/ordrequisicion/infbodega.php', {
                idx: idx
            });
        } else {
    ...
    function seleccionarDepartamento(sel) {
        ...
        $("#idprod").load('https://cw3.tierramontemariana.org/apps/ordrequisicion/producto.php', {
            idd: idd
        })
