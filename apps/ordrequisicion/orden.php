...
<script>
    ...
    function cargarTable() {
        ...
        $.ajax({
            type: 'POST',
            url: 'https://cw3.tierramontemariana.org/apps/ordrequisicion/confirmarordenes.php',
            data: {},
            success: function(respuesta) {
                $.ajax({
                    type: 'POST',
                    url: 'https://cw3.tierramontemariana.org/apps/ordrequisicion/mostrarequisicion.php',
                    data: {},
                    success: function(respuesta) {
                        Swal.fire({
                            icon: 'success',
