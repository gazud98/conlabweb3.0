...
?>
            ...
            <div class="col-md-12">
                <table class="table-txt-order">
                    <tr>
                        ...
                        <!--<td>
                            <label><strong>Base UVT:</strong></label>
                            <input type="input" class="formcontrol" name="licencia" id="licencia" readonly value="<?php echo $licencia; ?>"></input>
                        </td>-->
                        <td>
    ...
    <section class="p-3 col-md-12">
        <div class="row pb-2 mt-3 card card-body content-table-config" style="width:80%;margin:auto;">
    ...
    <script>
        ...
        function buscarData(id) {
            $.ajax({
                url: 'https://cw3.tierramontemariana.org/apps/configregimenfiscal/search-2.php?id=' + id,
