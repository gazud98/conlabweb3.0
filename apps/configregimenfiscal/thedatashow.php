...
if ($conetar->connect_errno) {
    ...
    /* */
?>
    <div class=" bg-light col-md-12 col-lg-12 p-2" name="accionejec" id="accionejec" style="text-align:center; font-weight:bold;display:none; background-color:#ededed;"></div><?php //Aqui se esceo lo que va a pasar 
                                                                                                                                                                                ?>

    <div class="col-md-12 col-lg-12 p-3" name="iddatas" id="iddatas">
        <div class="row" name="casoesperado" id="casoesperado"><?php include('datacase1.php');  //campos de la app 
