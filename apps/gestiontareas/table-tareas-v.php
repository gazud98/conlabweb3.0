...
<table class="table table-tareas-v" style="width: 100%;">
    <thead>
        <tr id="theadtaraeas">
            <th></th>
            <th></th>
...
<script>
    $(document).ready(function() {
        miDataTablev = $('.table-tareas-v').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/gestiontareas/mostrar-3.php', // Página PHP que devuelve los datos en formato JSON
    ...
    function cargarDatosv() {
        $.ajax({
            ...
            success: function(data) {
                ...
                miDataTablev.clear().rows.add(data).draw();
            },
