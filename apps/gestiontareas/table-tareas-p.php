...
<table class="table table-tareas-p" style="width: 100%;">
    <thead>
        <tr id="theadtaraeas">
            <th></th>
            <th></th>
...
<script>
    $(document).ready(function() {
        miDataTablep = $('.table-tareas-p').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/gestiontareas/mostrar-4.php', // Página PHP que devuelve los datos en formato JSON
    ...
    function cargarDatosp() {
        $.ajax({
            ...
            success: function(data) {
                ...
                miDataTablep.clear().rows.add(data).draw();
            },
