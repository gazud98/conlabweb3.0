...
<script>
    $(document).ready(function() {
        ...
        $("#search-tarea").load("https://cw3.tierramontemariana.org/apps/gestiontareas/search.php");
        ...
        miDataTableh = $('.table-tareas').DataTable({
            ...
            "responsive": true,
            "ajax": {
                url: 'https://cw3.tierramontemariana.org/apps/gestiontareas/mostrar.php', // Página PHP que devuelve los datos en formato JSON
    ...
    function updateEstado() {
        $.ajax({
            type: 'POST',
            url: 'https://cw3.tierramontemariana.org/apps/gestiontareas/crud.php?aux=2',
    ...
    function setComments() {
        $.ajax({
            type: 'POST',
            url: 'https://cw3.tierramontemariana.org/apps/gestiontareas/crud.php?aux=3',
    ...
    function getEstado(id) {
        $.ajax({
            type: 'POST',
            url: 'https://cw3.tierramontemariana.org/apps/gestiontareas/mostrar-2.php?aux=2&id=' + id,
    ...
    function getComments(id) {
        ...
        $.ajax({
            type: 'POST',
            url: 'https://cw3.tierramontemariana.org/apps/gestiontareas/mostrar-2.php?aux=3&id=' + id,
            success: function(res) {
                data = JSON.parse(res);
    ...
    function getRowsComments(id) {
        ...
        $.ajax({
            type: 'POST',
            url: 'https://cw3.tierramontemariana.org/apps/gestiontareas/mostrar-2.php?aux=4&id=' + id,
            success: function(res) {
                $('#rows').html(res);
            }
        });
