...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm">
    ...
    <tbody>
        ...
        //******************************************************************************
            ...
            $cadena="SELECT P.id, P.equipo,P.fecha_comienzo,P.estado,E.nombre
                    FROM  u116753122_cw3completa.preventiva P,u116753122_cw3completa.producto E where P.equipo=E.id_producto";
                      //echo $cadena;
                     /* */
            ...
            if($numerfiles2>=1){
                ...
                while($filaP2=mysqli_fetch_array($resultadP2)){
                    ...
                    $fecha_comienzo=$filaP2['fecha_comienzo'];
