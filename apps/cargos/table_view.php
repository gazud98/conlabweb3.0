...
<script>
    ...
    $(document).ready(function() {
        miDataTable = $('.table-cargos').DataTable({
            ...
            "responsive": true,
            "ajax": {
                url: 'https://cw3.tierramontemariana.org/apps/cargos/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: 'https://cw3.tierramontemariana.org/apps/cargos/crud.php',
    ...
    function editar(id) {
        ...
        $.ajax({
            type: 'GET',
            url: 'https://cw3.tierramontemariana.org/apps/cargos/process_data.php',
            data: {
                id: id
            },
            dataType: 'json',
