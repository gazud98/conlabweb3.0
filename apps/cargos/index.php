...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/cargos/assets/style.css">
</head>
<style>
    .content-wrapper {
...
<body>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.content-table-cargos').load('https://cw3.tierramontemariana.org/apps/cargos/table_view.php');
