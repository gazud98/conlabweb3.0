...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm table responsive"
    id="table-ctrocosto" style="
                    font-size: 15px;
                    text-align: center;
...
<script>
    function exportarExcel() {
        ...
        var tabla = document.getElementById('table-ctrocosto');
    ...
    $(document).ready(function () {
        miDataTable = $('#table-ctrocosto').DataTable({
            language: {
            ...
            "responsive": true,
            "ajax": {
                url: 'https://conlabweb3.tierramontemariana.org/apps/ctrocosto/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function () {
                $.ajax({
                    type: 'POST',
                    url: 'https://conlabweb3.tierramontemariana.org/apps/ctrocosto/crud.php',
                    ...
                    success: function (respuesta) {
                        ...
                        if (respuesta == 1) {
                            Swal.fire({
                                icon: 'error',
                                title: 'Oops...',
                                text: '¡Este Centro de Costo ya existe!',
                                footer: 'Crea un Centro de Costo con un nuevo nombre'
                            })
                        } else {
                            Swal.fire({
                                position: 'top',
    ...
    function editar(id) {
        $.ajax({
            type: 'GET',
            url: 'https://conlabweb3.tierramontemariana.org/apps/ctrocosto/process_data.php',
            data: { id: id },
            dataType: 'json',
