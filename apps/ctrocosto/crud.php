...
if ($conetar->connect_errno) {
    ...
    if ($modeeditstatus == "D") { //es de desahibilitar/habikitr
        ...
        $cadena = "select estado from u116753122_cw3completa.centro_costos where id='" . $id . "'";
        ...
        $cadena = "update u116753122_cw3completa.centro_costos set estado='" . $estado . "' where id='" . $id . "'";
        ...
        if ($modeeditstatus == "C") { ////CREACION
            $consulta = "SELECT nombre FROM u116753122_cw3completa.centro_costos WHERE nombre = '$nombre'";
            ...
            if (mysqli_num_rows($resultado) > 0) {
                ...
                $cadena = "insert into u116753122_cw3completa.centro_costos(nombre,estado)values('" . $nombre . "',1)";
                $resultado = mysqli_query($conetar, $cadena);
            }
            ...
            if ($modeeditstatus == "E") { //acgualzucsion
                $cadena = "update u116753122_cw3completa.centro_costos set
                                nombre='" . $nombre . "'
                            where id='" . $id . "'";
                $resultado = mysqli_query($conetar, $cadena);
                ...
                if ($modeeditstatus == "B") { //acgualzucsion
                    $cadena = "DELETE FROM u116753122_cw3completa.centro_costos where id='" . $id . "'";
                    $resultado = mysqli_query($conetar, $cadena);
                }
            }
        } //De es insetar
