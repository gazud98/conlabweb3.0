...
$nmbapp = "Creación de Centros de Costos";
...
<head>
    ...
    <title></title>
    <link rel="stylesheet" href="https://conlabweb3.tierramontemariana.org/apps/ctrocosto/assets/style.css">
</head>
<style>
    .content-wrapper {
...
<body>
    ...
    <div class="card" style="width:85%;margin:auto;">
        ...
        <div class="card-header bg-light ">
            ...
            <div class="row">
                ...
                <div class="col-md-4 text-center">
                    <h5 style="text-align: center; color: #0045A5;"><strong>Creación de Centros de Costos</strong></h5>
                </div>
                <div class="col-md-4 text-right">
                    <button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#addModal"
                        style="font-size:11px;background-color: rgb(0,69,165);border:none;"><i
                            class="fas fa-plus"></i>&nbsp;&nbsp;Nuevo Centro Costos</button>
                </div>
            </div>
        </div>
        ...
        <div class="card-body">
            ...
            <div class="row mt-3">
                <div class="col-md-12 content-table-ctrocosto">
            ...
            <div class="modal-content">
                <form name="formcontrol" id="formcontrol" action="" method="POST" enctype="multipart/form-data">
                    <div class="modal-header">
                        <h4 class="modal-title">Crear Centros de Costo</h4>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.content-table-ctrocosto').load('https://conlabweb3.tierramontemariana.org/apps/ctrocosto/table_view.php');
