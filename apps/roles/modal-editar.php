...
if ($conetar->connect_errno) {
    ...
    $cadena = "select id ,nombre,id_modulo,estado
from u116753122_cw3completa.roles
where id='" . $id . "'";
    //                     echo $cadena;
    ...
    if ($numerfiles2 >= 1) {
        ...
        $id_modulo = trim($filaP2['id_modulo']);
    ...
    <div class="form-group">
        <label>Codigo</label>
        <input type="text" class="form-control" name="id" id="id" required readonly style="border:none;"
            value="<?php echo $id ?>">
    </div>
    <div class="form-group">
        <label>Nombre</label>
    ...
    <div class="form-group" style="height: 200px; overflow-y: auto;">
        ...
        $idsGuardados = explode(',', $id_modulo);
        if ($numerfiles2a33 >= 1) {
            while ($filaP2a33 = mysqli_fetch_array($resultadP2a33)) {
                ...
                <div class="form-check">
                    <input type="checkbox" style="font-size: 12px;" class="form-check-input" name="regimen[]"
                        value="<?= $id_modulos ?>" id="checkreg<?= $id_modulos ?>" <?= $checked ?>>
    ...
    <input type="hidden" name="idmodul" id="idmodul" value="">
...
<script>
    $(document).ready(function () {
        ...
        $('input[type="checkbox"]').change(function () {
            ...
            $('#idmodul').val(opcionesSeleccionadas);
            ...
            submitHandler: function () {
                $.ajax({
                    ...
                    success: function (respuesta) {
                        cargarDatos();
                        //$('.content-table-dptos').load('/cw3/conlabweb3.0/apps/dptos/thedatatable.php');
