...
if ($conetar->connect_errno) {
    ...
    // echo $sctrl1;
    $nmbapp = "CREACIÓN DE ACTIVIDADES";
    $moduraiz = $_SESSION['moduraiz'];
    $ruta =  "<a href='#'>Home</a> / " . $moduraiz;
    $uppercaseruta = strtoupper($ruta);
    //echo ".................".$sctrl4."-----------";
    $cadena = "SELECT count(*) as cantidad
                    FROM  u116753122_cw3completa.actividad_seguimiento where 1=1";
    ...
    <body>
        ...
        <div class="content-table">
            ...
            <div class="table-wrapper">
                        ...
                        <div class="col-md-4">
                            <div class="">
                                <nav class="breadcrumbs">
                                    ...
                                    <a href="#" class="breadcrumbs__item is-active" style="text-decoration: none;">Creacion de Actividades</a>
                                </nav>
                ...
                <div class="content-table-creaactividad">
                ...
                <div class="modal-content">
                    <form name="formcontrol" id="formcontrol" action="" method="POST" enctype="multipart/form-data">
                        <div class="modal-header">
                            <h4 class="modal-title">Crear Actividades</h4>
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                $('.content-table-creaactividad').load('https://cw3.tierramontemariana.org/apps/creaactividad/thedatatable.php');
