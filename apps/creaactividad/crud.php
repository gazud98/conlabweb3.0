...
if ($conetar->connect_errno) {
    ...
    if ($modeeditstatus == "D") { //es de desahibilitar/habikitr
        ...
        $cadena = "select estado from u116753122_cw3completa.actividad_seguimiento where id='" . $id . "'";
        ...
        $cadena = "update u116753122_cw3completa.actividad_seguimiento set estado='" . $estado . "' where id='" . $id . "'";
        ...
        if ($modeeditstatus == "C") { ////CREACION
            $cadena = "insert into u116753122_cw3completa.actividad_seguimiento(nombre,estado)values('" . $nombre . "',1)";
            $resultado = mysqli_query($conetar, $cadena);
            ...
            if ($modeeditstatus == "E") { //acgualzucsion
                ...
                if ($modeeditstatus == "B") { //acgualzucsion
                    $cadena = "DELETE FROM u116753122_cw3completa.actividad_seguimiento where id='" . $id . "'";
                    $resultado = mysqli_query($conetar, $cadena);
                }
            }
        } //De es insetar
