...
<table class="table table-striped table-hover table-head-fixed text-nowrap table-sm" id="table-bodega" style="
                    font-size: 15px;
                    text-align: center;
...
<script>
    function exportarExcel() {
        ...
        var tabla = document.getElementById('table-bodega');
    ...
    $(document).ready(function() {
        miDataTable = $('#table-bodega').DataTable({
            ...
            "responsive": true,
            "ajax": {
                url: 'https://cw3.tierramontemariana.org/apps/bodega/show_data.php', // Página PHP que devuelve los datos en formato JSON
        ...
        $.validator.setDefaults({
            submitHandler: function() {
                $.ajax({
                    type: 'POST',
                    url: 'https://cw3.tierramontemariana.org/apps/bodega/crud.php',
                    ...
                    success: function(respuesta) {
                        if (respuesta == 1) {
                            Swal.fire({
                                icon: 'error',
                                title: 'Oops...',
                                text: '¡Esta Bodega ya existe!',
                                footer: 'Crea una Bodega con un nuevo nombre'
                            })
                        } else {
                            Swal.fire({
                                position: 'top',
    ...
    function editar(id) {
        ...
        $('#modalshow').load('https://cw3.tierramontemariana.org/apps/bodega/modal-editar.php', {
            id: id
        });
