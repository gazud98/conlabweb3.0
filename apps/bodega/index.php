...
?>
    ...
    <head>
        ...
        <title></title>
        <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/bodega/assets/style.css">
    </head>
    <style>
        .content-wrapper {
    ...
    <body>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('.content-table-bodega').load('https://cw3.tierramontemariana.org/apps/bodega/table_view.php');
