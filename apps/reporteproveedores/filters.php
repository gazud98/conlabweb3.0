...
<div class="row border">
    <div class="col-md-2">
        <label for="" style="font-size:14px;">Filtrar por Departamento:</label>
    ...
    <div class="col-md-2">
        <label for="" style="font-size:14px;">Filtrar por categoria:</label>
        <select name="cat" id="cat" class="form-control" style="font-size:14px;">
            <option value="" selected >Todos</option>
            <?php
