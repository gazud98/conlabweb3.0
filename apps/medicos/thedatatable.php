    ...
    <script>
        $(document).ready(function() {
            ...
            new DataTable('.table-medicos', {
                ...
                "responsive": true,
                "ajax": {
                    url: '/cw3/conlabweb3.0/apps/medicos/mostrar.php?aux=1', // Página PHP que devuelve los datos en formato JSON
            ...
            $.validator.setDefaults({
                submitHandler: function() {
                    $.ajax({
                        type: 'POST',
                        url: '/cw3/conlabweb3.0/apps/medicos/crud.php?aux=1',
        ...
        function deleteMedico(id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    $.ajax({
                        type: 'POST',
                        url: '/cw3/conlabweb3.0/apps/medicos/crud.php',
                        data: {
                            id: id,
                            modeeditstatus: 'B'
                        },
        ...
        function editar(id) {
            ...
            $('#editMedicos').load('/cw3/conlabweb3.0/apps/medicos/modal-editar.php', {
                id: id,
                status: 'E'
            });
