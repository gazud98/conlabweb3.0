...
//          si estadio es 1 pasa ra 0 o v iceversa
        $cadena="select estado from cw3completa.departamentos where id='".$id."'";
        ...
        $cadena= "update cw3completa.departamentos set estado='".$estado."' where id='".$id."'";
        ...
        $estado=trim($_POST['estado']);
            ...
            if($modeeditstatus=="C"){////CREACION
                $cadena="insert into cw3completa.departamentos(nombre,estado)values('".$nombre."','1')";
                $resultado = mysqli_query($conetar,$cadena);
                    $result="ok";
            }else{
                if($modeeditstatus=="E"){//acgualzucsion
                    $cadena="update cw3completa.departamentos set
                                nombre='".$nombre."'
                            where id='".$id."'";
                    $resultado = mysqli_query($conetar,$cadena);
