...
?>
    ...
    <link rel="stylesheet" href="https://cw3.tierramontemariana.org/apps/listainventario/assets/style.css">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#thetable').load('https://cw3.tierramontemariana.org/apps/listainventario/tabla.php');
