    ...
    <script>
        $(document).ready(function() {
            ...
            miDataTable = $('.table-inventario').DataTable({
                ...
                // ... Otras opciones ...
                "ajax": {
                    url: 'https://cw3.tierramontemariana.org/apps/listainventario/mostrar.php', // Página PHP que devuelve los datos en formato JSON
        ...
        function handleEnter(event, id) {
            if (event.key === 'Enter') {
                ...
                $.ajax({
                    method: 'POST',
                    url: 'https://cw3.tierramontemariana.org/apps/listainventario/crud.php?aux=1',
                    data: {
        ...
        function setOk(id){
            $.ajax({
                    method: 'POST',
                    url: 'https://cw3.tierramontemariana.org/apps/listainventario/crud.php?aux=2',
                    data: {
                        id: $('#idp-'+id).val()
                    },
                    success: function(res) {
        ...
        function getOk(id){
            $.ajax({
                    method: 'GET',
                    url: 'https://cw3.tierramontemariana.org/apps/listainventario/crud.php?aux=3',
                    data: {
                        id: $('#idp-'+id).val()
                    },
                    success: function(res) {
