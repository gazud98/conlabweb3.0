<script>
    ...
    function selectthefile(caso, estado) {
        ...
        try {
            if (caso == 1) {
                document.getElementById("thefileselected1").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 2) {
                document.getElementById("thefileselected2").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 3) {
                document.getElementById("thefileselected3").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 4) {
                document.getElementById("thefileselected4").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 5) {
                document.getElementById("thefileselected5").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 6) {
                document.getElementById("thefileselected6").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 7) {
                document.getElementById("thefileselected7").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 8) {
                document.getElementById("thefileselected8").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 9) {
                document.getElementById("thefileselected9").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 10) {
                document.getElementById("thefileselected10").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 11) {
                document.getElementById("thefileselected11").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 12) {
                document.getElementById("thefileselected12").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 13) {
                document.getElementById("thefileselected13").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 14) {
                document.getElementById("thefileselected14").style.border = '4px groove #dc3545';
            } else {
        ...
        try {
            if (caso == 15) {
                document.getElementById("thefileselected15").style.border = '4px groove #dc3545';
            } else {
        ...
        if (elementoActivo) {
            ...
            var iduser = elementoActivo.getAttribute("iduser");
