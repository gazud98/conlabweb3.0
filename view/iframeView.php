...
<body class="hold-transition sidebar-mini layout-fixed sidebar-mini layout-fixed sidebar-collapse text-sm" data-panel-auto-height-mode="height" style="overflow:hidden;">
  ...
  <script>
    function ejecutarTareat() {
      $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/gestiontareas/comprobar.php',
    ...
    function getRowsCommentsUser() {
      ...
      $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/gestiontareas/mostrar-2.php?aux=5&user=<?php echo $user; ?>',
    ...
    $(document).ready(function() {
      ...
      dataTableTask = $('.table-task').DataTable({
        ...
        "responsive": true,
        "ajax": {
          url: '/cw3/conlabweb3.0/apps/gestiontareas/mostrar-tareas-user.php?user=<?php echo $user; ?>',
          type: 'GET',
          dataType: 'json',
          dataSrc: ''
        },
    ...
    function ejecutarTareat() {
      $.ajax({
        type: 'POST',
        url: '/cw3/conlabweb3.0/apps/consultamantenimiento/comprobar.php',
        success: function(rows) {
          // Manejar la respuesta exitosa
          console.log('Consulta exitosa', rows);
        },
